...
TEST(TransactionPlan, OneTypical) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {100'000}, 50'000, 147), "");
...
TEST(TransactionPlan, OneInsufficient) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {}, 0, 0), "");
}
...
TEST(TransactionPlan, OneFitsExactly) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {100'000}, 100'000 - 226, expectedFee), "");
...
TEST(TransactionPlan, OneFitsExactlyHighFee) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {100'000}, 100'000 - 2260, expectedFee), "");
...
TEST(TransactionPlan, TwoFirstEnough) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {20'000}, 15'000, 147), "");
}
...
TEST(TransactionPlan, TwoSecondEnough) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {80'000}, 70'000, 147), "");
}
...
TEST(TransactionPlan, TwoBoth) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {20'000, 80'000}, 90'000, 215), "");
}
...
TEST(TransactionPlan, TwoFirstEnoughButSecond) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {22'000}, 18'000, 147), "");
}
...
TEST(TransactionPlan, ThreeNoDust) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {75'000, 100'000}, 100'000 - 226 - 10, 215), "");
    ...
    EXPECT_EQ(verifyPlan(txPlan, {100'000}, 100'000 - 226 - 546, 147), "");

    // One more and we are over dust limit
    sigingInput = buildSigningInput(100'000 - 226 - 546 + 1, 1, utxos);
    txPlan = TransactionBuilder::plan(sigingInput);
    EXPECT_EQ(verifyPlan(txPlan, {75'000, 100'000}, 100'000 - 226 - 546 + 1, 215), "");
}
...
TEST(TransactionPlan, TenThree) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {100'000, 125'000, 150'000}, 300'000, 283), "");
}
...
TEST(TransactionPlan, NonMaxAmount) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {50000}, 10000, 147), "");
}
...
TEST(TransactionPlan, CustomCase) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {794121, 2289357}, 2287189, 13115), "");
...
TEST(TransactionPlan, MaxAmount) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {15000, 15000}, 30000 - 5792, 5792), "");
}
...
TEST(TransactionPlan, MaxAmountOne) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {10189534}, 10189534 - expectedFee, expectedFee), "");
}
...
TEST(TransactionPlan, MaxAmount4of5) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {500, 600, 800, 1000}, 2'900 - expectedFee, expectedFee), "");
...
TEST(TransactionPlan, One_MaxAmount_FeeMoreThanAvailable) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {170}, 170 - expectedFee, expectedFee), "");
...
TEST(TransactionPlan, MaxAmountDoge) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {100000000, 2000000000, 200000000}, 2300000000, 0), "");
}
...
TEST(TransactionPlan, AmountDecred) {
    ...
    EXPECT_EQ(verifyPlan(txPlan, {39900000}, 10000000, 0), "");
}
