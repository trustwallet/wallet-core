...
TEST(BitcoinSigning, EncodeThreeOutput) {
    ...
    EXPECT_EQ(hex(unsignedData), // printed using prettyPrintTransaction
              ...
              "0001"             // marker & flag
              "01"               // inputs
              "fe554f0068ed898680772f7a4d3e0a97385f4df20fff5d0278463ca6ad36e7bb"
              "00000000"
              "00"
              ""
              "ffffffff"
              ...
              "40420f0000000000"
              "16"
              "001445a70b76fbdea0c9d5598c51cdd1d8ab455ab965"
              "80841e0000000000"
              "16"
              "0014e7d0b03506234b334e742192bd48968584f4a7f1"
              "c9fe0c0000000000"
              "16"
              "00145c74be45eb45a3459050667529022d9df8a1ecff"
              // witness
    ...
    EXPECT_EQ(hex(unsignedData), // printed using prettyPrintTransaction
              ...
              "02"
              "48"
              "30450221008d88197a37ffcb51ecacc7e826aa588cb1068a107a82373c4b54ec42318a395c02204abbf5408504614d8f943d67e7873506c575e85a5e1bd92a02cd345e5192a82701"
              "21"
              "036739829f2cfec79cfe6aaf1c22ecb7d4867dfd8ab4deb7121b36a00ab646caed"
              "00000000" // nLockTime
    );
...
TEST(BitcoinSigning, Build_OpReturn_THORChainSwap_eb4c) {
    ...
    EXPECT_EQ(hex(unsignedData), // printed using prettyPrintTransaction
              ...
              "5d14000000000000"
              "16"
              "0014f41fd57ebd472d0cdcc7ba4b1bc0a4423fa9c8cd"
              "0000000000000000"
              "3d"
