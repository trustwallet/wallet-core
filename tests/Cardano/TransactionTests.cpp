...
TEST(CardanoTransaction, Encode) {
    ...
    EXPECT_EQ(hex(encoded), "");

    {
        const auto decode = Cbor::Decode(encoded);
        ASSERT_TRUE(decode.isValid());
        EXPECT_EQ(decode.getMapElements().size(), 4);
        EXPECT_EQ(decode.dumpToString(), "{0: [[h\"f074134aabbfb13b8aec7cf5465b1e5a862bde5cb88532cc7e64619179b3e767\", 1], [h\"554f2fd942a23d06835d26bbd78f0106fa94c8a551114a0bef81927f66467af0\", 0]], 1: [[h\"015fa3c167f5d4abc7fa76974cb27fdbf5e1f505affe027557b48706c5cc64bf258b8e330cf0cdd9fdb03e10b4e4ac08f5da1fdec6222a3468\", 2000000], [h\"018d98bea0414243dc84070f96265577e7e6cf702d62e871016885034ecc64bf258b8e330cf0cdd9fdb03e10b4e4ac08f5da1fdec6222a3468\", 16749189]], 2: 165555, 3: 53333345}");
    }
}
