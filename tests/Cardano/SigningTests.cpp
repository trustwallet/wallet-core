...
TEST(CardanoSigning, SignTransferToken) {
...

    {
        ...
        EXPECT_EQ(plan.fee, 174072ul);
        EXPECT_EQ(plan.change, 8432858ul);
        EXPECT_EQ(plan.utxos.size(), 2ul);
    ...
    EXPECT_EQ(output.error(), Common::Proto::OK);
    const auto encoded = data(output.encoded());
    EXPECT_EQ(hex(encoded), "");
    const auto txid = data(output.tx_id());
    EXPECT_EQ(hex(txid), "3ee2488fffdb82acb97d929fdd3d87e7952e6c188579accc9741e01c027fab94");

    {
        ...
        EXPECT_EQ(plan2.change, 8432858ul);
    }
}
