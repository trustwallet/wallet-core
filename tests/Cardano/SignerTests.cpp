...
TEST(CardanoAddress, SignTx_d498) {
    ...
    ASSERT_EQ(
        "d498c692e3101a39d19da9c7a7beccd65c7d1ea6d23008806ac8d46e81e4918f",
...
TEST(CardanoAddress, PrepareUnsignedTx_d498) {
    ...
    Data fromPri = parse_hex("b8c31abcc41d931ae881be11da9e4d9242b1f01cae4e69fa29d5ba1f89f9c1549ec844c6b39c70fa6d3a254fe57c1efee1a75eb9755e0b751e96dd288deabc881ae60957699bf72b212ca823520cf7d86af5d1304cd90248fe60bd1fe442870f");
    PrivateKey fromPriKey = PrivateKey(fromPri);
    ...
    ASSERT_EQ(
        "Ae2tdPwUPEZ6SqAETdiJgPYHpAey2MWakEVRDESWYzBePi7u5uAL5ah26qx",
        fromAddr.string()
    );
}
...
TEST(CardanoAddress, SignTx_8283) {
    ...
    ASSERT_EQ(
        "ebf58670ee1512d597876fe632e92790bd70568374bdbe5a69c5d8ed107607ee",
        output.transaction_id()
    );
}
