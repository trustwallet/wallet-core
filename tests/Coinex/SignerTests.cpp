...
TEST(CoinexSigner, SignTx) {
    ...
    auto toAddress = TW::Cosmos::Address::decode("cettest1ykaa52ajdxqeu2248vhk5j5k5qqtwtwdhk63w2").first;
    ...
    ASSERT_EQ("{\"mode\":\"block\",\"tx\":{\"fee\":{\"amount\":[{\"amount\":\"2000000\",\"denom\":\"cet\"}],\"gas\":\"100000\"},\"memo\":\"ifwallet\",\"msg\":[{\"type\":\"bankx/MsgSend\",\"value\":{\"amount\":[{\"amount\":\"1000000\",\"denom\":\"cet\"}],\"from_address\":\"cettest1hkfq3zahaqkkzx5mjnamwjsfpq2jk7z0dsez0j\",\"to_address\":\"cettest1ykaa52ajdxqeu2248vhk5j5k5qqtwtwdhk63w2\",\"unlock_time\":\"0\"}}],\"signatures\":[{\"pub_key\":{\"type\":\"tendermint/PubKeySecp256k1\",\"value\":\"AkvCoxJlFT8H5w4LqwhyTmuF4hf4zWKM62KXQke7STOC\"},\"signature\":\"FWe7WHEeWEqW17gKVC9HJ8vjX1qVXuiuHMcX5FotyLddqrhkMLT/9aFcyErG4Q/pKU+fotwUPXRYn51GQ0qDqw==\"}],\"type\":\"bankx/MsgSend\"}}", output.json());
