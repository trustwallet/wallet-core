...
TEST(Bech32Address, FromPublicKey) {
    {
        ...
        auto address = Bech32Address("bnb", Hash::Hash_sha256ripemd, publicKey);
    ...
    }
    {
        ...
        auto address = Bech32Address("cosmos", Hash::Hash_sha256ripemd, publicKey);
    ...
    }
    {
        ...
        auto address = Bech32Address("one", Hash::Hash_keccak256, publicKey);
    ...
    }
    {
        ...
        auto publicKey = privateKey.getPublicKey(TWPublicKeyTypeSECP256k1Extended);
        auto address = Bech32Address("io", Hash::Hash_keccak256, publicKey);
    ...
    }
    {
        ...
        const auto address = Bech32Address("zil", Hash::Hash_sha256, publicKey);
...
TEST(Bech32Address, Hashes) {
    ...
    const auto address1 = Bech32Address("hrp", Hash::Hash_sha256ripemd, publicKey1);
    ASSERT_EQ("hrp186zwn9h0z9fyvwfqs4jl92cw3kexusm4xw6ptp", address1.string());

    const auto address2 = Bech32Address("hrp", Hash::Hash_sha256, publicKey1);
    ...
    const auto address3 = Bech32Address("hrp", Hash::Hash_keccak256, publicKey2);
...
TEST(Bech32Address, Prefixes) {
    ...
    const auto address1 = Bech32Address("hrpone", Hash::Hash_sha256ripemd, publicKey);
    ASSERT_EQ("hrpone186zwn9h0z9fyvwfqs4jl92cw3kexusm47das6p", address1.string());
    const auto address2 = Bech32Address("hrptwo", Hash::Hash_sha256ripemd, publicKey);
    ASSERT_EQ("hrptwo186zwn9h0z9fyvwfqs4jl92cw3kexusm4qzr8p7", address2.string());
    const auto address3 = Bech32Address("hrpthree", Hash::Hash_sha256ripemd, publicKey);
