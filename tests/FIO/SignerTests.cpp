...
TEST(FIOSigner, SignInternals) {
    ...
    Data sign1 = Signer::signData(pk, hash);
    EXPECT_EQ("1f4ae8d1b993f94d0de4b249d5185481770de0711863ad640b3aac21de598fcc02761c6e5395106bafb7b09aab1c7aa5ac0573dbd821c2d255725391a5105d30d1", hex(sign1));
    Data sign2 = Signer::sign(pk, rawData);
