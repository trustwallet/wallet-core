...
TEST(TransactionCompiler, IoTeXCompileWithSignatures) {
    ...
    const auto ExpectedTx0 = "";
    const auto ExpectedTx1 = "";
    ...
    {   // Negative: not enough signatures
        const Data outputData = TransactionCompiler::compileWithSignatures(coin, inputData, {}, {pbkey0.bytes});
    ...
    { // Negative: not enough publicKey
        const Data outputData = TransactionCompiler::compileWithSignatures(coin, inputData, {signature}, {});
    ...
    { // Negative: not one to on
        const Data outputData = TransactionCompiler::compileWithSignatures(coin, inputData, {signature}, {pbkey0.bytes, pbkey1.bytes});
