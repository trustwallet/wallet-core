...
TEST(CryptoorgAddress, Invalid) {
    EXPECT_FALSE(Address::isValid("cro1ctwtcwpgksky988dhth6jslxveumgu0d45zgf1"));
    EXPECT_FALSE(Address::isValid("cro1z53wwe7md6cewz9sqwqzn0aavpaun0gw39h3re"));
    EXPECT_FALSE(Address::isValid("cosmos1hsk6jryyqjfhp5dhc55tc9jtckygx0eph6dd02")); // valid cosmos
}
