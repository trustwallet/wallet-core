...
TEST(TWTHORChainCoinType, TWCoinType) {
    ...
    auto accId = WRAPS(TWStringCreateWithUTF8Bytes("bnb1czhptncu9uhhlrlrk9q0rmy459gae2ua79mapn"));
    ...
    assertStringsEqual(accUrl, "https://viewblock.io/thorchain/address/bnb1czhptncu9uhhlrlrk9q0rmy459gae2ua79mapn");
