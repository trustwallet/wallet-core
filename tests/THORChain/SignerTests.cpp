...
TEST(THORChainSigner, SignTx) {
    ...
    auto& inputCosmos = *input.mutable_input();
    inputCosmos.set_memo("memo1234");

    auto msg = inputCosmos.add_messages();
    ...
    auto& fee = *inputCosmos.mutable_fee();
    fee.set_gas(2000000);
    ...
    EXPECT_EQ(R"({"input":{"fee":{"amounts":[{"denom":"rune","amount":"200"}],"gas":"2000000"},"memo":"memo1234","messages":[{"sendCoinsMessage":{"fromAddress":"thor1z53wwe7md6cewz9sqwqzn0aavpaun0gw0exn2r","toAddress":"thor1e2ryt8asq4gu0h6z2sx9u7rfrykgxwkmr9upxn","amounts":[{"denom":"rune","amount":"50000000"}]}}]}})", json);

    auto privateKey = parse_hex("7105512f0c020a1dd759e14b865ec0125f59ac31e34d7a2807a228ed50cb343e");
    inputCosmos.set_private_key(privateKey.data(), privateKey.size());
