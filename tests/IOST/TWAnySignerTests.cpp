...
TEST(TWAnySignerIOST, Sign) {
    ...
    ANY_SIGN(input, TWCoinTypeIOST);
    ASSERT_EQ(hex(output.transaction().publisher_sigs(0).signature()),
              "e8ce15214bad39683021c15dd318e963da8541fd8f3d8484df5042b4ea7fdafb7f46505b85841367d6e1"
              "736c7d3b433ca72089b88a23f43661dfb0429a10cb03");
}
