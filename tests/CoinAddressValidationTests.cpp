...
TEST(Coin, validateAddressIocoin) {
    EXPECT_TRUE(validateAddress(TWCoinTypeIocoin, "ik6V522aupkj3kMtJZi6eDw6v3eLgMbXY8"));
    EXPECT_FALSE(validateAddress(TWCoinTypeIocoin, "xk6V522aupkj3kMtJZi6eDw6v3eLgMbXY8"));
}
