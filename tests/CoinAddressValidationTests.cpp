...
TEST(Coin, ValidateAddressOasisProtocol) {
    EXPECT_TRUE(validateAddress(TWCoinTypeOasisProtocol, "oasis1qp0cnmkjl22gky6p6qeghjytt4v7dkxsrsmueweh"));
    EXPECT_FALSE(validateAddress(TWCoinTypeOasisProtocol, "oasi1qp0cnmkjl22gky6p6qeghjytt4v7dkxsrsmueweh"));
}
