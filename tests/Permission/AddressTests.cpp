...
TEST(PermissionAddress, Invalid) {
...
TEST(PermissionAddress, FromPrivateKey) {
...
TEST(PermissionAddress, IsValid) {
    ASSERT_FALSE(Address::isValid("abc"));
