...
TEST(NEOCoinReference, Serialize) {
    ...
    ASSERT_EQ(prevHash + "0100", hex(coinReference.serialize()));
}
...
TEST(NEOCoinReference, Deserialize) {
    ...
    ASSERT_EQ("bdecbb623eee6f9ade28d5a8ff5fb3ea9c9d73af039e0286201b3b0291fb4d4a", hex(store(coinReference.prevHash)));
    ASSERT_EQ(1, coinReference.prevIndex);
}
