...
TEST(TWAnySignerDecred, Plan) {
    ...
    EXPECT_EQ(plan.fee(), 0);
    EXPECT_EQ(plan.change(), 29900000);
...
TEST(TWAnySignerDecred, PlanAndSign) {
    ...
    *input.mutable_plan() = plan;
    ...
    ASSERT_TRUE(output.error().empty());
    ASSERT_EQ(hex(output.encoded()), "");
}
