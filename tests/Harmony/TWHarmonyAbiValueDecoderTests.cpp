...
#include <TrustWalletCore/TWHarmonyAbiValueDecoder.h>
...
TEST(TWHarmonyAbiValueDecoder, decodeUInt256) {
    ...
    for (auto &input: inputs) {
        ...
        auto result = WRAPS(TWHarmonyAbiValueDecoderDecodeUInt256(data.get()));
