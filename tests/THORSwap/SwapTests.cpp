...
TEST(THORSwap, SwapBtcEth) {
    auto res = Swap::build(Chain::BTC, Chain::ETH, Address1Btc, "ETH", "", Address1Eth, VaultEth, "100000");
...
TEST(THORSwap, SwapBnbBtc) {
    ...
    EXPECT_EQ(hex(res.first), "");
...
TEST(THORSwap, SwapBnbRune) {
    ...
    ASSERT_EQ(res.second, "");
    EXPECT_EQ(hex(res.first), "");
