...
TEST(OntologyOnt, queryBalance) {
    ...
    EXPECT_EQ(85,
              serializedTx.find("d1446b1a18af6b7c9f8a4602f9f73eeb3030f0c29b70962616c616e63654f66"));
...
TEST(OntologyOnt, transfer) {
    ...
    EXPECT_EQ(86, serializedTx.find(
                      "00c66b14fbacc8214765d457c8e3f2b5a1d3c4981a2e9d2a6a7cc814feec06b79ed299ea06fc"
                      "b94abac41aaf3ead76586a7cc8516a7cc86c51c1087472616e73666572"));
    EXPECT_EQ(220, serializedTx.find("1400000000000000000000000000000000000000010068164f6e746f6c6f6"
                                     "7792e4e61746976652e496e766f6b"));
    EXPECT_EQ(452, serializedTx.find(
                       "031bec1250aa8f78275f99a6663688f31085848d0ed92f1203e447125f927b7486"));
    EXPECT_EQ(656, serializedTx.find(
                       "03d9fd62df332403d9114f3fa3da0d5aec9dfa42948c2f50738d52470469a1a1ee"));
}