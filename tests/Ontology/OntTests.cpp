...
TEST(OntologyOnt, queryBalance) {
    ...
    ASSERT_EQ(86, serializedTx.find(
            "1446b1a18af6b7c9f8a4602f9f73eeb3030f0c29b70962616c616e63654f661400000000000000000000000000000000000000010068164f6e746f6c6f67792e4e61746976652e496e766f6b65"));
    EXPECT_EQ(13, serializedTx.find(
            ""));
...
TEST(OntologyOnt, transfer) {
    ...
    auto tx = Ont().transfer(acct1, toAddress, amount, acct1, gasPrice, gasLimit);
    auto serializedTx = hex(tx.serialize());
    EXPECT_EQ(316, serializedTx.length());
    EXPECT_EQ(0, serializedTx.find("00d1"));
    EXPECT_EQ(13, serializedTx.find("401000000000000204e000000000000fbacc8214765d457c8e3f2b5a1d3c4981a2e9d2a71"));
    ...
    tx.sign(acct1);
    serializedTx = hex(tx.serialize());
    EXPECT_EQ(520, serializedTx.length());
