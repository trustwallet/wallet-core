...
TEST(StoredKey, MissingAddress) {
    ...
    EXPECT_EQ(key.account(TWCoinTypeEthereum, "password").address, "0x04De84ec355BAe81b51cD53Fdc8AA30A61872C95");
    EXPECT_EQ(key.account(TWCoinTypeBitcoin, "password").address, "bc1qe938ncm8fhdqg27xmxd7lq02jz9xh0x48r22lc");
}
