...
TEST(Viacoin, LegacyAddress) {
    ...
    auto address = TWBitcoinAddressCreateWithPublicKey(publicKey, TWCoinTypeConfigurationGetP2PKHPrefix(TWCoinTypeViacoin));
...
TEST(Viacoin, DeriveFromXpub) {
    ...
    auto address2 = TWBitcoinAddressCreateWithPublicKey(pubKey2, TWCoinTypeConfigurationGetP2PKHPrefix(TWCoinTypeViacoin));
    auto address2String = WRAPS(TWBitcoinAddressDescription(address2));

    auto address9 = TWBitcoinAddressCreateWithPublicKey(pubKey9, TWCoinTypeConfigurationGetP2PKHPrefix(TWCoinTypeViacoin));
