...
TEST(TWCoinType, TWPurpose) {
    ...
    ASSERT_EQ(TWPurposeBIP44, TWCoinTypePurpose(TWCoinTypeEnergyWebToken));
}
...
TEST(TWCoinType, TWPublicKeyType) {
    ...
    ASSERT_EQ(TWPublicKeyTypeSECP256k1Extended, TWCoinTypePublicKeyType(TWCoinTypeEnergyWebToken));
}