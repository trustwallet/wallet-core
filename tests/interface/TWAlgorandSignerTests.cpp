...
TEST(TWAlgorandSigner, Sign) {
    ...
    input.set_to_address("CRLADAHJZEW2GFY2UPEHENLOGCUOU74WYSTUXQLVLJUJFHEUZOHYZNWYR4");
    input.set_fee(263000ull);
    input.set_amount(1000000000000ull);
    ...
    ASSERT_EQ(hex(output.signature()), "baa00062adcdcb5875e4435cdc6885d26bfe5308ab17983c0fda790b7103051fcb111554e5badfc0ac7edf7e1223a434342a9eeed5cdb047690827325051560b");
}
