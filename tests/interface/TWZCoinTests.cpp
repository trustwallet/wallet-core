...
TEST(ZCoin, Address) {
    ...
    auto address = TWBitcoinAddressCreateWithPublicKey(publicKey, TWCoinTypeConfigurationGetP2PKHPrefix(TWCoinTypeZcoin));
...
TEST(Zcoin, DeriveFromXpub) {
    ...
    auto address3 = TWBitcoinAddressCreateWithPublicKey(pubKey3, TWCoinTypeConfigurationGetP2PKHPrefix(TWCoinTypeZcoin));
    auto address3String = WRAPS(TWBitcoinAddressDescription(address3));

    auto address5 = TWBitcoinAddressCreateWithPublicKey(pubKey5, TWCoinTypeConfigurationGetP2PKHPrefix(TWCoinTypeZcoin));
