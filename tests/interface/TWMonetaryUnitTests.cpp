...
TEST(MonetaryUnit, TransparentAddress) {
    ...
    auto address = TWBitcoinAddressCreateWithPublicKey(publicKey, TWCoinTypeConfigurationGetP2PKHPrefix(TWCoinTypeMonetaryUnit));
...
TEST(MonetaryUnit, DerivePubkeyFromXpub) {
    ...
    auto address3 = TWBitcoinAddressCreateWithPublicKey(pubKey3, TWCoinTypeConfigurationGetP2PKHPrefix(TWCoinTypeMonetaryUnit));
    auto address3String = WRAPS(TWBitcoinAddressDescription(address3));

    auto address5 = TWBitcoinAddressCreateWithPublicKey(pubKey5, TWCoinTypeConfigurationGetP2PKHPrefix(TWCoinTypeMonetaryUnit));
