...
TEST(DeepOnionTransaction, SignTransaction) {
    ...
    */
    ...
    auto utxoKey0 = DATA("27bde28c59d4f1b9c6ebb5b6397cc4c2f651ac6a980222422885b9e554ff8824");
...
TEST(DeepOnionTransaction, LockScripts) {
    ...
    auto script = WRAP(TWBitcoinScript, TWBitcoinScriptBuildForAddress(STRING("DohbWhdFgC4KEr4SM7vBSuhQ3hNqzNsLhs").get()));
    ...
    auto script2 = WRAP(TWBitcoinScript, TWBitcoinScriptBuildForAddress(STRING("DbmhitYuDmTLcL7KTDZzVTURfim3VACuzD").get()));
