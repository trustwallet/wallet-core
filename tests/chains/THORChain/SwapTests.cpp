...
TEST(THORChainSwap, SwapBtcBnb) {
    ...
    ASSERT_EQ(errorCode, 0);
    ASSERT_EQ(error, "");
    EXPECT_EQ(hex(out), "");
    ...
    EXPECT_EQ(hex(output.encoded()), // printed using prettyPrintTransaction
        ...
        "03" // outputs
            ...
            "c08c030000000000"  "16"  "00140cb9f5c6b62c03249367bc20a90dd2425e6926af"
            "0000000000000000"  "43"  "6a41535741503a424e422e424e423a626e62317573343777646866783038636839377a6475656833783375356d757266727833306a656372783a313430303030303030"
        // witness
            "02"
...
TEST(THORChainSwap, SwapEthBnb) {
    ...
    ASSERT_EQ(errorCode, 0);
    ASSERT_EQ(error, "");
    EXPECT_EQ(hex(out), "");
...
TEST(THORChainSwap, SwapBnbBtc) {
    ...
    ASSERT_EQ(errorCode, 0);
    ASSERT_EQ(error, "");
    EXPECT_EQ(hex(out), "");
...
TEST(THORChainSwap, SwapBnbRune) {
    ...
    ASSERT_EQ(errorCode, 0);
    ASSERT_EQ(error, "");
    EXPECT_EQ(hex(out), "");
...
TEST(THORChainSwap, SwapBnbBnbToken) {
    ...
    ASSERT_EQ(errorCode, 0);
    ASSERT_EQ(error, "");
    EXPECT_EQ(hex(out), "");
...
TEST(THORChainSwap, SwapEthBnbWithAffFee) {
    ...
    ASSERT_EQ(errorCode, 0);
    ASSERT_EQ(error, "");
    EXPECT_EQ(hex(out), "");
    ...
    auto func = Ethereum::ABI::Function("deposit", std::vector<std::shared_ptr<Ethereum::ABI::ParamBase>>{
                                                       ...
                                                       std::make_shared<Ethereum::ABI::ParamAddress>(parse_hex("0000000000000000000000000000000000000000")),
                                                       std::make_shared<Ethereum::ABI::ParamUInt256>(uint256_t(50000000000000000)),
                                                       std::make_shared<Ethereum::ABI::ParamString>("SWAP:BNB.BNB:bnb1us47wdhfx08ch97zdueh3x3u5murfrx30jecrx:600003:tthor1ql2tcqyrqsgnql2tcqyj2n8kfdmt9lh0yzql2tcqy:10")});
    Data payload;
    func.encode(payload);
    EXPECT_EQ(hex(payload), "1fece7b4"
                            "0000000000000000000000001091c4de6a3cf09cda00abdaed42c7c3b69c83ec"
                            ...
                            "535741503a424e422e424e423a626e6231757334377764686678303863683937"
                            "7a6475656833783375356d757266727833306a656372783a3630303030333a74"
                            "74686f7231716c3274637179727173676e716c32746371796a326e386b66646d"
                            "74396c6830797a716c32746371793a3130000000000000000000000000000000");
