...
TEST(THORChainSwap, SwapBtcBnb) {
    ...
    ASSERT_EQ(std::get<1>(res), 0);
    ASSERT_EQ(std::get<2>(res), "");
    EXPECT_EQ(hex(std::get<0>(res)), "");
...
TEST(THORChainSwap, SwapEthBnb) {
    ...
    ASSERT_EQ(std::get<1>(res), 0);
    ASSERT_EQ(std::get<2>(res), "");
    EXPECT_EQ(hex(std::get<0>(res)), "");
...
TEST(THORChainSwap, SwapBnbBtc) {
    ...
    ASSERT_EQ(std::get<1>(res), 0);
    ASSERT_EQ(std::get<2>(res), "");
    EXPECT_EQ(hex(std::get<0>(res)), "");
...
TEST(THORChainSwap, SwapBnbRune) {
    ...
    ASSERT_EQ(std::get<1>(res), 0);
    ASSERT_EQ(std::get<2>(res), "");
    EXPECT_EQ(hex(std::get<0>(res)), "");
    ...
    // change memo to match real tx
    tx.set_memo("SWAP:THOR.RUNE:thor1z53wwe7md6cewz9sqwqzn0aavpaun0gw0exn2r:121065076");
    ASSERT_TRUE(tx.has_send_order());
    ASSERT_EQ(tx.send_order().inputs_size(), 1);
    ASSERT_EQ(tx.send_order().outputs_size(), 1);
    EXPECT_EQ(hex(tx.send_order().inputs(0).address()), "e42be736e933cf8b97c26f33789a3ca6f8348cd1");
...
TEST(THORChainSwap, SwapBnbBnbToken) {
    ...
    ASSERT_EQ(std::get<1>(res), 0);
    ASSERT_EQ(std::get<2>(res), "");
    EXPECT_EQ(hex(std::get<0>(res)), "");
    ...
    // change memo to match real tx
    tx.set_memo("SWAP:BNB.TWT-8C2:bnb1us47wdhfx08ch97zdueh3x3u5murfrx30jecrx:5400000000");
    ASSERT_TRUE(tx.has_send_order());
    ASSERT_EQ(tx.send_order().inputs_size(), 1);
    ASSERT_EQ(tx.send_order().outputs_size(), 1);
    EXPECT_EQ(hex(tx.send_order().inputs(0).address()), "e42be736e933cf8b97c26f33789a3ca6f8348cd1");
...
TEST(THORChainSwap, SwapBtcEthWithAffFee) {
    ...
    EXPECT_EQ(hex(output.encoded()), // printed using prettyPrintTransaction
        ...
        "03" // outputs
            ...
            "0000000000000000"  "53"  "6a4b3d3a4554482e4554483a3078623966353737316332373636346266323238326439386530396437663530636563376362303161373a3134303030303030303030303030303030303a746872056e6d3a3130"
        // witness
            "02"
...
TEST(THORChainSwap, SwapEthBnbWithAffFee) {
    ...
    ASSERT_EQ(std::get<1>(res), 0);
    ASSERT_EQ(std::get<2>(res), "");
    EXPECT_EQ(hex(std::get<0>(res)), "");
...
TEST(THORChainSwap, Memo) {
    EXPECT_EQ(Swap::buildMemo(Chain::BTC, "BTC", "", "btc123", 1234, "", std::nullopt, ""), "=:BTC.BTC:btc123:1234");
    EXPECT_EQ(Swap::buildMemo(Chain::BNB, "BNB", "", "bnb123", 1234, "", std::nullopt, ""), "=:BNB.BNB:bnb123:1234");
    ...
    EXPECT_EQ(Swap::buildMemo(Chain::BNB, "BNB", "TWT-8C2", "bnb123", 1234, "", std::nullopt, ""), "=:BNB.TWT-8C2:bnb123:1234");
    EXPECT_EQ(Swap::buildMemo(Chain::BTC, "BTC", "", "btc123", 1234, "feeaddr", std::nullopt, ""), "=:BTC.BTC:btc123:1234:feeaddr");
    EXPECT_EQ(Swap::buildMemo(Chain::BTC, "BTC", "", "btc123", 1234, "feeaddr", 10, ""), "=:BTC.BTC:btc123:1234:feeaddr:10");
    EXPECT_EQ(Swap::buildMemo(Chain::BTC, "BTC", "", "btc123", 1234, "feeaddr", 10, "extramemo"), "=:BTC.BTC:btc123:1234:feeaddr:10:extramemo");
    EXPECT_EQ(Swap::buildMemo(Chain::BTC, "BTC", "", "btc123", 1234, "feeaddr", 0, ""), "=:BTC.BTC:btc123:1234:feeaddr:0");
    EXPECT_EQ(Swap::buildMemo(Chain::BTC, "BTC", "", "btc123", 1234, "", 10, ""), "=:BTC.BTC:btc123:1234::10");
    EXPECT_EQ(Swap::buildMemo(Chain::BTC, "BTC", "", "btc123", 1234, "", std::nullopt, "extramemo"), "=:BTC.BTC:btc123:1234:::extramemo");
}
