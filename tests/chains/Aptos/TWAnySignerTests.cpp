...
TEST(TWAnySignerAptos, TxSignFungibleAssetTransfer) {
    ...
    auto msg = new Proto::FungibleAssetTransferMessage();
    msg->set_amount(100000000);
    msg->set_to("0x2d92d71078f11d923c2b703b95a288c0e2ae63c0d29154e6278bf8004f9b4e52");
    msg->set_metadata_address("0x2ebb2ccac5e027a87fa0e2e5f656a3a4238d6a48d93ec9b610d570fc0aa0df12");

    Proto::SigningInput input;
    input.set_sender("0x07968dab936c1bad187c60ce4082f307d030d780e91e694ae03aef16aba73f30");
    input.set_sequence_number(74);
    input.set_max_gas_amount(20);
    input.set_gas_unit_price(100);
    input.set_expiration_timestamp_secs(1736060099);
    input.set_chain_id(1);
    input.set_allocated_fungible_asset_transfer(msg);
    auto privateKey = PrivateKey(parse_hex("5d996aa76b3212142792d9130796cd2e11e3c445a93118c08414df4f66bc60ec"));
    input.set_private_key(privateKey.bytes.data(), privateKey.bytes.size());
    Proto::SigningOutput output;
    ANY_SIGN(input, TWCoinTypeAptos);
    ASSERT_EQ(hex(output.raw_txn()), "");
    ASSERT_EQ(hex(output.authenticator().signature()), "2d4c5cbb710b6ef92813597054dbf8d3014529a7d85f6393f01e2a3e978c461c6aa656475b98b453ed3faebf7aa1fdd912bfc59a0c1b6fc44330793994b2e40c");
    ASSERT_EQ(hex(output.encoded()), "");
}
