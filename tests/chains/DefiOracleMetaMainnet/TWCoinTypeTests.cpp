...
TEST(TWDefiOracleMetaMainnetCoinType, TWCoinType) {
    ...
    ASSERT_EQ(TWCoinTypeConfigurationGetBlockchain(coin), TWBlockchainEthereum);
    ASSERT_EQ(TWCoinTypeP2pkhPrefix(coin), 0);
    ASSERT_EQ(TWCoinTypeP2shPrefix(coin), 0);
    ASSERT_EQ(TWCoinTypeStaticPrefix(coin), 0);
    assertStringsEqual(txUrl, "https://blockscout.defi-oracle.io/tx/0xbc36c6050ea6b6f484009a1fcd8f8c6c2c2bd629661bc75fa5e84829c662a604");
    assertStringsEqual(accUrl, "https://blockscout.defi-oracle.io/address/0x4A666F96fC8764181194447A7dFdb7d471b301C8");
}
