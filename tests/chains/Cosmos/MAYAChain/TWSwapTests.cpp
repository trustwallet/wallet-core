...
namespace TW::MAYAChainSwap::tests {
...
TEST(TWMAYAChainSwap, SwapBtcToEth) {
    // prepare swap input
    ...
    *input.mutable_to_asset() = toAsset;
    ...
    // invoke swap
    const auto outputTWData_ = WRAPD(TWMAYAChainSwapBuildSwap(inputTWData_.get()));
...
TEST(TWMAYAChainSwap, SwapEthBnb) {
    // prepare swap input
    Proto::SwapInput input;
    Proto::Asset fromAsset;
...
TEST(TWMAYAChainSwap, SwapBnbBtc) {
    // prepare swap input
    Proto::SwapInput input;
    Proto::Asset fromAsset;
...
TEST(TWMAYAChainSwap, SwapAtomBnb) {
    // prepare swap input
    Proto::SwapInput input;
    Proto::Asset fromAsset;
...
TEST(TWMAYAChainSwap, NegativeInvalidInput) {
    ...
    const auto outputTWData = WRAPD(TWMAYAChainSwapBuildSwap(inputTWData.get()));
