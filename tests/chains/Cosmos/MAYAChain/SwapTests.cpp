...
#include "MAYAChain/Swap.h"
#include "proto/Binance.pb.h"
#include "proto/Bitcoin.pb.h"
#include "proto/Cosmos.pb.h"
#include "proto/Ethereum.pb.h"
#include "proto/MAYAChainSwap.pb.h"
...
TEST(MAYAChainSwap, OverflowFixEth) {
...
TEST(MAYAChainSwap, SwapDogeBusd) {
    Proto::Asset fromAsset;
    ...
    // https://viewblock.io/mayachain/tx/E7588A6A4C6B9DBA8B9AD8B0834655F9D9E5861744B5493E711623E320B981A5
...
TEST(MAYAChainSwap, SwapLtcBusd) {
    Proto::Asset fromAsset;
    ...
    // https://viewblock.io/mayachain/tx/FBB450335ED839C5FE3DCB9CBC0999DA6E6E52B787D1B165D3FA47E6273CCF5F
...
TEST(MAYAChainSwap, SwapBchBusd) {
    Proto::Asset fromAsset;
    ...
    // https://viewblock.io/mayachain/tx/B8AA6F2BFD09D7AC510BFCDA417903B2DDBEE0E9811821640D9C304B9B382B9B
...
TEST(MAYAChainSwap, SwapBtcBnb) {
    ...
    // https://viewblock.io/mayachain/tx/1CD9056B212B85D9D7D34D0795A746DD8691B8CD34EF56DF0AA9622FBDEC5F88
    // https://explorer.binance.org/tx/8D78469069118E9B9546696214CCD46E63D3FA0D7E854C094D63C8F6061278B7
}

TEST(MAYAChainSwap, SwapAtomBnb) {
    Proto::Asset fromAsset;
    ...
    // https://viewblock.io/mayachain/tx/07F47D71A74245538E205F24ADB4BBB799B49C3A8A8875665D249EA51662AA50
...
TEST(MAYAChainSwap, SwapAvaxBnb) {
    Proto::Asset fromAsset;
    ...
    // https://viewblock.io/mayachain/tx/8A29B132443BF1B0A0BD3E00F8155D10FEEEC7737BDC912C4A1AFB0A52E4FD4F
...
TEST(MAYAChainSwap, SwapBnbEth) {
    ...
    // https://viewblock.io/mayachain/tx/F0CFDB0D9467E83B5BBF6DF92E4E2D04FE9EFF9B0A1C71D88DCEF566233DCAA2
    // https://etherscan.io/tx/0x8e5bb7d87e17af86e649e402bc5c182ea8c32ddaca153804679de1184e0d9747
}

TEST(MAYAChainSwap, SwapBnbCacao) {
    Proto::Asset fromAsset;
    fromAsset.set_chain(static_cast<Proto::Chain>(Chain::BNB));
    Proto::Asset toAsset;
    ...
    // https://viewblock.io/mayachain/tx/D582E1473FE229F02F162055833C64F49FB4FF515989A4785ED7898560A448FC
}

TEST(MAYAChainSwap, SwapBusdTokenBnb) {
    Proto::Asset fromAsset;
    ...
    // https://viewblock.io/mayachain/tx/1B7E472C7C8D60176FCFD83CAD7DA970EB12B45145C553CD37BD34CABE276C59
...
TEST(MAYAChainSwap, SwapBnbBnbToken) {
    Proto::Asset fromAsset;
    fromAsset.set_chain(static_cast<Proto::Chain>(Chain::BNB));
    Proto::Asset toAsset;
    toAsset.set_chain(static_cast<Proto::Chain>(Chain::BNB));
    ...
    // https://viewblock.io/mayachain/tx/6D1EDC9BD9BFAFEF0F88F95A164191262EA02A0413BF3D9773110AD5676E1523
...
TEST(MAYAChainSwap, SwapBtcEthWithAffFee) {
    Proto::Asset fromAsset;
    fromAsset.set_chain(static_cast<Proto::Chain>(Chain::BTC));
    Proto::Asset toAsset;
    toAsset.set_chain(static_cast<Proto::Chain>(Chain::ETH));
...
TEST(MAYAChainSwap, SwapEthBnbWithAffFee) {
    Proto::Asset fromAsset;
    fromAsset.set_chain(static_cast<Proto::Chain>(Chain::ETH));
    Proto::Asset toAsset;
    toAsset.set_chain(static_cast<Proto::Chain>(Chain::BNB));
    ...
    auto&& [out, errorCode, error] = SwapBuilder::builder()
                                         ...
                                         .fromAmount("50000000000000000")
                                         .toAmountLimit("600003")
                                         .affFeeAddress("tmaya1ql2tcqyrqsgnql2tcqyj2n8kfdmt9lh0yzql2tcqy")
                                         .affFeeRate("10")
                                         .build();
    ASSERT_EQ(errorCode, 0);
    ASSERT_EQ(error, "");
    EXPECT_EQ(hex(out), "");
    ...
    Ethereum::Proto::SigningOutput output;
    ANY_SIGN(tx, TWCoinTypeEthereum);
    EXPECT_EQ(hex(output.encoded()), "");
}

TEST(MAYAChainSwap, SwapBtcNegativeMemoTooLong) {
    Proto::Asset fromAsset;
    fromAsset.set_chain(static_cast<Proto::Chain>(Chain::BTC));
    Proto::Asset toAsset;
    toAsset.set_chain(static_cast<Proto::Chain>(Chain::ETH));
...
TEST(MAYAChainSwap, WrongFromAddress) {
    Proto::Asset fromAsset;
    fromAsset.set_chain(static_cast<Proto::Chain>(Chain::BNB));
    Proto::Asset toAsset;
    toAsset.set_chain(static_cast<Proto::Chain>(Chain::ETH));
...
TEST(MAYAChainSwap, WrongToAddress) {
    Proto::Asset fromAsset;
    fromAsset.set_chain(static_cast<Proto::Chain>(Chain::BNB));
    Proto::Asset toAsset;
    toAsset.set_chain(static_cast<Proto::Chain>(Chain::ETH));
...
TEST(MAYAChainSwap, FromRuneNotSupported) {
    Proto::Asset fromAsset;
...
TEST(MAYAChainSwap, EthInvalidVault) {
    Proto::Asset fromAsset;
    fromAsset.set_chain(static_cast<Proto::Chain>(Chain::ETH));
    Proto::Asset toAsset;
    toAsset.set_chain(static_cast<Proto::Chain>(Chain::BNB));
