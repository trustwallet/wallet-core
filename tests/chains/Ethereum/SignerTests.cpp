...
TEST(EthereumSigner, ERC4337_NativeTransfer_Account_Not_Deployed) {
    const uint256_t chainID = 5;
    const auto transaction = UserOperation::buildNativeTransfer(
        /* entryPointAddress */ parse_hex("0x1306b01bC3e4AD202612D3843387e94737673F53"),
        /* senderAddress */ parse_hex("0x5A87209b755781cF65fEeEdd3855ade0317f4a92"),
        /* toAddress */ parse_hex("0x21cc27d7db4fa19857a3702653a7a67ee30ca620"),
        /* amount */ 0x2386f26fc10000,
        /* nonce */ 0x00,
        /* gasLimit */ 0x5580,
        /* verificationGasLimit */ 0x073272,
        /* maxFeePerGas */ 0x01952f1f85,
        /* maxInclusionFeePerGas */ 0x0f,
        /* preVerificationGas */ 0xbc18,
        /* paymasterAndData */ {},
        /* initCode */ parse_hex("0x21cc27d7db4fa19857a3702653a7a67ee30ca620")
        );

    const auto preHash = transaction->preHash(chainID);
    EXPECT_EQ(hexEncoded(preHash), "0x5d858133982b243229d9e1362aad3ad912164a1635ebf498bea665e0e0eb92e1");
...
//
TEST(EthereumSigner, ERC4337_NativeTransfer_Account_Deployed) {
    const uint256_t chainID = 5;
    const auto transaction = UserOperation::buildNativeTransfer(
        /* entryPointAddress */ parse_hex("0x1306b01bC3e4AD202612D3843387e94737673F53"),
        /* senderAddress */ parse_hex("0x5A87209b755781cF65fEeEdd3855ade0317f4a92"),
    ...
    const auto preHash = transaction->preHash(chainID);
    //EXPECT_EQ(hexEncoded(preHash), "0x2f0667a7146410bc27215beb98d60f15db0e2d4f6bf82302151dc30576f76c16");
...
TEST(EthereumSigner, EIP4337_ERC20_Transfer_Account_Deployed) {
    ...
    const auto transaction = UserOperation::buildERC20Transfer(
        /* entryPointAddress */ parse_hex("0x1306b01bC3e4AD202612D3843387e94737673F53"),
        /* senderAddress */ parse_hex("0x5A87209b755781cF65fEeEdd3855ade0317f4a92"),
        /* tokenContract */ parse_hex("0x21cc27d7db4fa19857a3702653a7a67ee30ca620"),
        /* toAddress */ parse_hex("0x78d9C32b96Bb872D66D51818227563f44e67E238"),
        /* amount */ 0x186a0,
        /* nonce */ 0x6,
        /* gasLimit */ 0xf78e,
        /* verificationGasLimit */ 0x186a0,
        /* maxFeePerGas */ 0x168ad5950f,
        /* maxInclusionFeePerGas */ 0xf,
        /* preVerificationGas */ 0xbb10
    );
...
TEST(EthereumSigner, EIP4337_ERC20_Approve_Account_Deployed) {
    ...
    const auto transaction = UserOperation::buildERC20Approve(
        ...
        /* senderAddress */ parse_hex("0x5A87209b755781cF65fEeEdd3855ade0317f4a92"),
        /* tokenContract */ parse_hex("0x21cc27d7db4fa19857a3702653a7a67ee30ca620"),
        /* spenderAddress */ parse_hex("0x78d9C32b96Bb872D66D51818227563f44e67E238"),
        /* amount */ 0x186a0,
        /* nonce */ 0x6,
        /* gasLimit */ 0xf78e,
        /* verificationGasLimit */ 0x186a0,
...
TEST(EthereumSigner, EIP4337_ERC721_Transfer_Account_Deployed) {
    ...
    const auto transaction = UserOperation::buildERC721Transfer(
        /* entryPointAddress */ parse_hex("0x1306b01bC3e4AD202612D3843387e94737673F53"),
        /* senderAddress */ parse_hex("0x5A87209b755781cF65fEeEdd3855ade0317f4a92"),
        /* tokenContract */ parse_hex("0x5A87209b755781cF65fEeEdd3855ade0317f4a92"),
        /* from */ parse_hex("0x21cc27d7db4fa19857a3702653a7a67ee30ca620"),
        /* to */ parse_hex("0x78d9C32b96Bb872D66D51818227563f44e67E238"),
        /* tokenId */ 0x1,
        /* nonce */ 0x6,
        /* gasLimit */ 0xf78e,
        /* verificationGasLimit */ 0x186a0,
