...
namespace TW::Ethereum {
    TEST(EthereumEip712, SignMessageAndVerifyLegacy) {
        PrivateKey ethKey(parse_hex("03a9ca895dca1623c7dfd69693f7b4111f5d819d2e145536e0b03c136025a25d"), TWCurveSECP256k1);
        auto msg = R"(
            {
                "types": {
                    "EIP712Domain": [
    ...
    TEST(EthereumEip191, SignMessageAndVerifyImmutableX) {
        PrivateKey ethKey(parse_hex("3b0a61f46fdae924007146eacb6db6642de7a5603ad843ec58e10331d89d4b84"), TWCurveSECP256k1);
    ...
    TEST(EthereumEip712, SignMessageAndVerifyEip155ChainIdString) {
        PrivateKey ethKey(parse_hex("9066aa168c379a403becb235c15e7129c133c244e56a757ab07bc369288bcab0"), TWCurveSECP256k1);
        // 5600
        auto chainId = 0x15e0;
        auto msg = R"(
                {
