...
TEST(TheOpenNetworkSigner, TransferAndDeploy) {
    ...
    transfer.set_expired_at(1671135440);
    ...
    ASSERT_EQ(hex(Everscale::Cell::fromBase64(output.encoded())->hash), "b3d9462c13a8c67e19b62002447839c386de51415ace3ff6473b1e6294299819");
...
TEST(TheOpenNetworkSigner, TransferOrdinary) {
    ...
    transfer.set_mode(Proto::SendMode::PAY_FEES_SEPARATELY | Proto::SendMode::IGNORE_ACTION_PHASE_ERRORS);
    transfer.set_expired_at(1671132440);
    ...
    ASSERT_EQ(hex(Everscale::Cell::fromBase64(output.encoded())->hash), "3908cf8b570c1d3d261c62620c9f368db11f6e821a07614cff64de2e7319f81b");
...
TEST(TheOpenNetworkSigner, TransferAllBalance) {
    ...
    ASSERT_EQ(hex(Everscale::Cell::fromBase64(output.encoded())->hash), "d5c5980c9083f697a7f114426effbbafac6d5c88554297d290eb65c8def3008e");
...
TEST(TheOpenNetworkSigner, TransferAllBalanceNonBounceable) {
    ...
    ASSERT_EQ(hex(Everscale::Cell::fromBase64(output.encoded())->hash), "e9c816780fa8e578bae309c2e098db8eb16aa25545b3ad2b61bb711ec9562795");
