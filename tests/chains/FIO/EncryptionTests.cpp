...
TEST(FIOEncryption, getSharedSecret) {
    ...
    {
        const PrivateKey privateKey(parse_hex("2bd806c97f0e00af1a1fc3328fa763a9269723c8db8fac4f93af71db186d6e90"), TWCurveSECP256k1);
    ...
    {
        const PrivateKey privateKey(parse_hex("81b637d8fcd2c6da6359e6963113a1170de795e4b725b84d1e0b4cfd9ec58ce9"), TWCurveSECP256k1);
    ...
    {
        const PrivateKey privateKey(parse_hex("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"), TWCurveSECP256k1);
...
TEST(FIOEncryption, encryptEncodeDecodeDecrypt) {
    const PrivateKey privateKeyAlice(parse_hex("2bd806c97f0e00af1a1fc3328fa763a9269723c8db8fac4f93af71db186d6e90"), TWCurveSECP256k1);
    ...
    const PrivateKey privateKeyBob(parse_hex("81b637d8fcd2c6da6359e6963113a1170de795e4b725b84d1e0b4cfd9ec58ce9"), TWCurveSECP256k1);
