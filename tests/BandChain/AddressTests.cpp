...
using namespace TW;
using namespace TW::BandChain;

TEST(BandChainAddress, Valid) {
    ASSERT_TRUE(Address::isValid("__ADD_VALID_ADDRESS_HERE__"));

    // TODO: Add more tests
}

TEST(BandChainAddress, Invalid) {
    ASSERT_FALSE(Address::isValid("__ADD_INVALID_ADDRESS_HERE__"));

    // TODO: Add more tests
}

TEST(BandChainAddress, FromPrivateKey) {
...
TEST(BandChainAddress, FromPublicKey) {
    // TODO: Check public key type, finalize implementation
...
TEST(BandChainAddress, FromString) {
