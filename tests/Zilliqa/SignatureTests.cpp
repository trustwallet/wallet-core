...
TEST(ZilliqaSignature, Signing) {
    ...
    auto keyData = WRAPD(TWDataCreateWithHexString("0xafeefca74d9a325cf1d6b6911d61a65c32afa8e02bd5e78e2e4ac2910bab45f5"));
    ...
    auto messageData = WRAPD(TWDataCreateWithBytes((uint8_t *)message, strlen(message)));
