...
TEST(Coin, DeriveAddress) {
    ...
    EXPECT_EQ(TW::deriveAddress(TWCoinTypeBitcoinSV, privateKey), "1JHMeqKunF2Up6zxnMQGhJu5667BXz98YQ");
    EXPECT_EQ(TW::deriveAddress(TWCoinTypeSimpleLedger, privateKey), "bitcoincash:qz7eyzytkl5z6cg6nw20hd62pyyp22mcfuardfd2vn");
    ...
    EXPECT_EQ(TW::deriveAddress(TWCoinTypeLitecoin, privateKey), "LcWJv3djruGY4uh7xVPZyKxqJJUTdrzqL7");
