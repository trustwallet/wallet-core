...
using namespace TW;
using namespace TW::Polygon;

TEST(PolygonAddress, Valid) {
    ASSERT_TRUE(Address::isValid("__ADD_VALID_ADDRESS_HERE__"));

    // TODO: Add more tests
}

TEST(PolygonAddress, Invalid) {
    ASSERT_FALSE(Address::isValid("__ADD_INVALID_ADDRESS_HERE__"));

    // TODO: Add more tests
}

TEST(PolygonAddress, FromPrivateKey) {
...
TEST(PolygonAddress, FromPublicKey) {
    // TODO: Check public key type, finalize implementation
...
TEST(PolygonAddress, FromString) {
