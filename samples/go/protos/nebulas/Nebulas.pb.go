...
const file_Nebulas_proto_rawDesc = "" +
	"\n" +
	"\rNebulas.proto\x12\x10TW.Nebulas.Proto\x1a\fCommon.proto\"\xac\x02\n" +
	"\fSigningInput\x12!\n" +
	...
	"\x03raw\x18\x03 \x01(\tR\x03raw\x123\n" +
...
var file_Nebulas_proto_depIdxs = []int32{
	4, // 0: TW.Nebulas.Proto.SigningOutput.error:type_name -> TW.Common.Proto.SigningError
	2, // 1: TW.Nebulas.Proto.RawTransaction.data:type_name -> TW.Nebulas.Proto.Data
