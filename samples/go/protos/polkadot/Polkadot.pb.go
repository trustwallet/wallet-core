...
func (x *Staking) GetBondExtraAndNominate() *Staking_BondExtraAndNominate {
	if x != nil {
		if x, ok := x.MessageOneof.(*Staking_BondExtraAndNominate_); ok {
			return x.BondExtraAndNominate
		}
	}
	return nil
}
...
type Staking_BondExtraAndNominate_ struct {
	BondExtraAndNominate *Staking_BondExtraAndNominate `protobuf:"bytes,10,opt,name=bond_extra_and_nominate,json=bondExtraAndNominate,proto3,oneof"`
}
...
func (*Staking_BondExtraAndNominate_) isStaking_MessageOneof() {}
...
type SigningInput struct {
	...
	ChargeNativeAsAssetTxPayment bool `protobuf:"varint,13,opt,name=charge_native_as_asset_tx_payment,json=chargeNativeAsAssetTxPayment,proto3" json:"charge_native_as_asset_tx_payment,omitempty"`
	// Payload message
	//
	// Types that are valid to be assigned to MessageOneof:
	//
...
func (x *SigningInput) GetChargeNativeAsAssetTxPayment() bool {
	if x != nil {
		return x.ChargeNativeAsAssetTxPayment
	}
	return false
}
...
type Staking_BondExtraAndNominate struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// amount (uint256, serialized big endian)
	Value []byte `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
	// list of nominators
	Nominators []string `protobuf:"bytes,2,rep,name=nominators,proto3" json:"nominators,omitempty"`
	// Batch call indices
	CallIndices *CallIndices `protobuf:"bytes,3,opt,name=call_indices,json=callIndices,proto3" json:"call_indices,omitempty"`
	// Staking.BondExtra call indices
	BondExtraCallIndices *CallIndices `protobuf:"bytes,4,opt,name=bond_extra_call_indices,json=bondExtraCallIndices,proto3" json:"bond_extra_call_indices,omitempty"`
	// Staking.Nominate call indices
	NominateCallIndices *CallIndices `protobuf:"bytes,5,opt,name=nominate_call_indices,json=nominateCallIndices,proto3" json:"nominate_call_indices,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}

func (x *Staking_BondExtraAndNominate) Reset() {
	*x = Staking_BondExtraAndNominate{}
	mi := &file_Polkadot_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Staking_BondExtraAndNominate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Staking_BondExtraAndNominate) ProtoMessage() {}

func (x *Staking_BondExtraAndNominate) ProtoReflect() protoreflect.Message {
	mi := &file_Polkadot_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Staking_BondExtraAndNominate.ProtoReflect.Descriptor instead.
func (*Staking_BondExtraAndNominate) Descriptor() ([]byte, []int) {
	return file_Polkadot_proto_rawDescGZIP(), []int{4, 2}
}

func (x *Staking_BondExtraAndNominate) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Staking_BondExtraAndNominate) GetNominators() []string {
	if x != nil {
		return x.Nominators
	}
	return nil
...
func (x *Staking_BondExtraAndNominate) GetCallIndices() *CallIndices {
	if x != nil {
		return x.CallIndices
	}
	return nil
...
func (x *Staking_BondExtraAndNominate) GetBondExtraCallIndices() *CallIndices {
	if x != nil {
		return x.BondExtraCallIndices
	}
	return nil
}

func (x *Staking_BondExtraAndNominate) GetNominateCallIndices() *CallIndices {
	if x != nil {
		return x.NominateCallIndices
	}
	return nil
...
func (*Staking_Chill) Descriptor() ([]byte, []int) {
	return file_Polkadot_proto_rawDescGZIP(), []int{4, 9}
}
...
const file_Polkadot_proto_rawDesc = "" +
	...
	"\x06rebond\x18\t \x01(\v2!.TW.Polkadot.Proto.Staking.RebondH\x00R\x06rebond\x12h\n" +
	"\x17bond_extra_and_nominate\x18\n" +
	" \x01(\v2/.TW.Polkadot.Proto.Staking.BondExtraAndNominateH\x00R\x14bondExtraAndNominate\x1a\xd4\x01\n" +
	"\x04Bond\x12\x1e\n" +
	"\n" +
	...
	"\x15nominate_call_indices\x18\a \x01(\v2\x1e.TW.Polkadot.Proto.CallIndicesR\x13nominateCallIndices\x1a\xba\x02\n" +
	"\x14BondExtraAndNominate\x12\x14\n" +
	"\x05value\x18\x01 \x01(\fR\x05value\x12\x1e\n" +
	"\n" +
	"nominators\x18\x02 \x03(\tR\n" +
	"nominators\x12A\n" +
	"\fcall_indices\x18\x03 \x01(\v2\x1e.TW.Polkadot.Proto.CallIndicesR\vcallIndices\x12U\n" +
	"\x17bond_extra_call_indices\x18\x04 \x01(\v2\x1e.TW.Polkadot.Proto.CallIndicesR\x14bondExtraCallIndices\x12R\n" +
	"\x15nominate_call_indices\x18\x05 \x01(\v2\x1e.TW.Polkadot.Proto.CallIndicesR\x13nominateCallIndices\x1ad\n" +
	"\tBondExtra\x12\x14\n" +
	...
	"\rmulti_address\x18\n" +
	" \x01(\bR\fmultiAddress\x12G\n" +
	"!charge_native_as_asset_tx_payment\x18\r \x01(\bR\x1cchargeNativeAsAssetTxPayment\x12?\n" +
...
var file_Polkadot_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_Polkadot_proto_goTypes = []any{
	...
	(*Staking_BondExtraAndNominate)(nil), // 14: TW.Polkadot.Proto.Staking.BondExtraAndNominate
	(*Staking_BondExtra)(nil),            // 15: TW.Polkadot.Proto.Staking.BondExtra
	(*Staking_Unbond)(nil),               // 16: TW.Polkadot.Proto.Staking.Unbond
	(*Staking_Rebond)(nil),               // 17: TW.Polkadot.Proto.Staking.Rebond
	(*Staking_WithdrawUnbonded)(nil),     // 18: TW.Polkadot.Proto.Staking.WithdrawUnbonded
	(*Staking_Nominate)(nil),             // 19: TW.Polkadot.Proto.Staking.Nominate
	(*Staking_ChillAndUnbond)(nil),       // 20: TW.Polkadot.Proto.Staking.ChillAndUnbond
	(*Staking_Chill)(nil),                // 21: TW.Polkadot.Proto.Staking.Chill
...
var file_Polkadot_proto_depIdxs = []int32{
	...
	15, // 7: TW.Polkadot.Proto.Staking.bond_extra:type_name -> TW.Polkadot.Proto.Staking.BondExtra
	16, // 8: TW.Polkadot.Proto.Staking.unbond:type_name -> TW.Polkadot.Proto.Staking.Unbond
	18, // 9: TW.Polkadot.Proto.Staking.withdraw_unbonded:type_name -> TW.Polkadot.Proto.Staking.WithdrawUnbonded
	19, // 10: TW.Polkadot.Proto.Staking.nominate:type_name -> TW.Polkadot.Proto.Staking.Nominate
	21, // 11: TW.Polkadot.Proto.Staking.chill:type_name -> TW.Polkadot.Proto.Staking.Chill
	20, // 12: TW.Polkadot.Proto.Staking.chill_and_unbond:type_name -> TW.Polkadot.Proto.Staking.ChillAndUnbond
	17, // 13: TW.Polkadot.Proto.Staking.rebond:type_name -> TW.Polkadot.Proto.Staking.Rebond
	14, // 14: TW.Polkadot.Proto.Staking.bond_extra_and_nominate:type_name -> TW.Polkadot.Proto.Staking.BondExtraAndNominate
	1,  // 15: TW.Polkadot.Proto.SigningInput.era:type_name -> TW.Polkadot.Proto.Era
	4,  // 16: TW.Polkadot.Proto.SigningInput.balance_call:type_name -> TW.Polkadot.Proto.Balance
	5,  // 17: TW.Polkadot.Proto.SigningInput.staking_call:type_name -> TW.Polkadot.Proto.Staking
	22, // 18: TW.Polkadot.Proto.SigningOutput.error:type_name -> TW.Common.Proto.SigningError
	3,  // 19: TW.Polkadot.Proto.Balance.Transfer.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 20: TW.Polkadot.Proto.Balance.BatchTransfer.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	8,  // 21: TW.Polkadot.Proto.Balance.BatchTransfer.transfers:type_name -> TW.Polkadot.Proto.Balance.Transfer
	3,  // 22: TW.Polkadot.Proto.Balance.AssetTransfer.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 23: TW.Polkadot.Proto.Balance.BatchAssetTransfer.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	10, // 24: TW.Polkadot.Proto.Balance.BatchAssetTransfer.transfers:type_name -> TW.Polkadot.Proto.Balance.AssetTransfer
	0,  // 25: TW.Polkadot.Proto.Staking.Bond.reward_destination:type_name -> TW.Polkadot.Proto.RewardDestination
	3,  // 26: TW.Polkadot.Proto.Staking.Bond.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	0,  // 27: TW.Polkadot.Proto.Staking.BondAndNominate.reward_destination:type_name -> TW.Polkadot.Proto.RewardDestination
	3,  // 28: TW.Polkadot.Proto.Staking.BondAndNominate.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 29: TW.Polkadot.Proto.Staking.BondAndNominate.bond_call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 30: TW.Polkadot.Proto.Staking.BondAndNominate.nominate_call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 31: TW.Polkadot.Proto.Staking.BondExtraAndNominate.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 32: TW.Polkadot.Proto.Staking.BondExtraAndNominate.bond_extra_call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 33: TW.Polkadot.Proto.Staking.BondExtraAndNominate.nominate_call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 34: TW.Polkadot.Proto.Staking.BondExtra.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 35: TW.Polkadot.Proto.Staking.Unbond.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 36: TW.Polkadot.Proto.Staking.Rebond.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 37: TW.Polkadot.Proto.Staking.WithdrawUnbonded.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 38: TW.Polkadot.Proto.Staking.Nominate.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 39: TW.Polkadot.Proto.Staking.ChillAndUnbond.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 40: TW.Polkadot.Proto.Staking.ChillAndUnbond.chill_call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 41: TW.Polkadot.Proto.Staking.ChillAndUnbond.unbond_call_indices:type_name -> TW.Polkadot.Proto.CallIndices
	3,  // 42: TW.Polkadot.Proto.Staking.Chill.call_indices:type_name -> TW.Polkadot.Proto.CallIndices
...
func file_Polkadot_proto_init() {
	...
	file_Polkadot_proto_msgTypes[4].OneofWrappers = []any{
		...
		(*Staking_Rebond_)(nil),
		(*Staking_BondExtraAndNominate_)(nil),
	}
