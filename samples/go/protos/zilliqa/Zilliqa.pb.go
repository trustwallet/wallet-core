...
const file_Zilliqa_proto_rawDesc = "" +
	"\n" +
	"\rZilliqa.proto\x12\x10TW.Zilliqa.Proto\x1a\fCommon.proto\"\x9d\x02\n" +
	"\vTransaction\x12D\n" +
	...
	"privateKey\x12?\n" +
	"\vtransaction\x18\a \x01(\v2\x1d.TW.Zilliqa.Proto.TransactionR\vtransaction\"\x9b\x01\n" +
	"\rSigningOutput\x12\x1c\n" +
	"\tsignature\x18\x01 \x01(\fR\tsignature\x12\x12\n" +
	"\x04json\x18\x02 \x01(\tR\x04json\x123\n" +
...
var file_Zilliqa_proto_depIdxs = []int32{
	...
	5, // 3: TW.Zilliqa.Proto.SigningOutput.error:type_name -> TW.Common.Proto.SigningError
