...
const file_Aeternity_proto_rawDesc = "" +
	"\n" +
	"\x0fAeternity.proto\x12\x12TW.Aeternity.Proto\x1a\fCommon.proto\"\xdd\x01\n" +
	"\fSigningInput\x12!\n" +
...
var file_Aeternity_proto_depIdxs = []int32{
	2, // 0: TW.Aeternity.Proto.SigningOutput.error:type_name -> TW.Common.Proto.SigningError
