...
type JettonTransfer struct {
	...
	// uint128 / big endian byte order
	JettonAmount []byte `protobuf:"bytes,2,opt,name=jetton_amount,json=jettonAmount,proto3" json:"jetton_amount,omitempty"`
	...
	// uint128 / big endian byte order
	ForwardAmount []byte `protobuf:"bytes,5,opt,name=forward_amount,json=forwardAmount,proto3" json:"forward_amount,omitempty"`
	// Optional raw one-cell BoC encoded in Base64.
...
func (x *JettonTransfer) GetJettonAmount() []byte {
	if x != nil {
...
func (x *JettonTransfer) GetForwardAmount() []byte {
	if x != nil {
...
const file_TheOpenNetwork_proto_rawDesc = "" +
	...
	"\rjetton_amount\x18\x02 \x01(\fR\fjettonAmount\x12\x19\n" +
	"\bto_owner\x18\x03 \x01(\tR\atoOwner\x12)\n" +
	"\x10response_address\x18\x04 \x01(\tR\x0fresponseAddress\x12%\n" +
	"\x0eforward_amount\x18\x05 \x01(\fR\rforwardAmount\x12%\n" +
