...
const file_Hedera_proto_rawDesc = "" +
	"\n" +
	"\fHedera.proto\x12\x0fTW.Hedera.Proto\x1a\fCommon.proto\";\n" +
	"\tTimestamp\x12\x18\n" +
	...
	"privateKey\x124\n" +
	"\x04body\x18\x02 \x01(\v2 .TW.Hedera.Proto.TransactionBodyR\x04body\"\x83\x01\n" +
...
var file_Hedera_proto_depIdxs = []int32{
	...
	6, // 4: TW.Hedera.Proto.SigningOutput.error:type_name -> TW.Common.Proto.SigningError
