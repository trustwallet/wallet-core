...
type TokenTransferToFeePayer struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Mint address of the fee token
	FeeTokenMintAddress string `protobuf:"bytes,1,opt,name=fee_token_mint_address,json=feeTokenMintAddress,proto3" json:"fee_token_mint_address,omitempty"`
	// Token account address of the fee recipient.
	// Note that it could be different from the token account of the feepayer.
	FeeRecipientTokenAddress string `protobuf:"bytes,2,opt,name=fee_recipient_token_address,json=feeRecipientTokenAddress,proto3" json:"fee_recipient_token_address,omitempty"`
	// Fee amount
	FeeAmount uint64 `protobuf:"varint,3,opt,name=fee_amount,json=feeAmount,proto3" json:"fee_amount,omitempty"`
	// Sender's fee token address
	FeeSenderTokenAddress string `protobuf:"bytes,4,opt,name=fee_sender_token_address,json=feeSenderTokenAddress,proto3" json:"fee_sender_token_address,omitempty"`
	// Note: 8-bit value
	FeeDecimals uint32 `protobuf:"varint,5,opt,name=fee_decimals,json=feeDecimals,proto3" json:"fee_decimals,omitempty"`
	// optional token program id
	FeeTokenProgramId TokenProgramId `protobuf:"varint,6,opt,name=fee_token_program_id,json=feeTokenProgramId,proto3,enum=TW.Solana.Proto.TokenProgramId" json:"fee_token_program_id,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *TokenTransferToFeePayer) Reset() {
	*x = TokenTransferToFeePayer{}
	mi := &file_Solana_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TokenTransferToFeePayer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TokenTransferToFeePayer) ProtoMessage() {}

func (x *TokenTransferToFeePayer) ProtoReflect() protoreflect.Message {
	mi := &file_Solana_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TokenTransferToFeePayer.ProtoReflect.Descriptor instead.
func (*TokenTransferToFeePayer) Descriptor() ([]byte, []int) {
	return file_Solana_proto_rawDescGZIP(), []int{10}
}

func (x *TokenTransferToFeePayer) GetFeeTokenMintAddress() string {
	if x != nil {
		return x.FeeTokenMintAddress
	}
	return ""
}

func (x *TokenTransferToFeePayer) GetFeeRecipientTokenAddress() string {
	if x != nil {
		return x.FeeRecipientTokenAddress
	}
	return ""
}

func (x *TokenTransferToFeePayer) GetFeeAmount() uint64 {
	if x != nil {
		return x.FeeAmount
	}
	return 0
...
func (x *TokenTransferToFeePayer) GetFeeSenderTokenAddress() string {
	if x != nil {
		return x.FeeSenderTokenAddress
	}
	return ""
}

func (x *TokenTransferToFeePayer) GetFeeDecimals() uint32 {
	if x != nil {
...
func (x *TokenTransferToFeePayer) GetFeeTokenProgramId() TokenProgramId {
	if x != nil {
		return x.FeeTokenProgramId
	}
	return TokenProgramId_TokenProgram
}
...
type SigningInput struct {
	...
	TokenTransferToFeePayer *TokenTransferToFeePayer `protobuf:"bytes,24,opt,name=token_transfer_to_fee_payer,json=tokenTransferToFeePayer,proto3" json:"token_transfer_to_fee_payer,omitempty"`
	...
	TransferToFeePayer *Transfer `protobuf:"bytes,25,opt,name=transfer_to_fee_payer,json=transferToFeePayer,proto3" json:"transfer_to_fee_payer,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *SigningInput) GetTokenTransferToFeePayer() *TokenTransferToFeePayer {
	if x != nil {
		return x.TokenTransferToFeePayer
	}
	return nil
}

func (x *SigningInput) GetTransferToFeePayer() *Transfer {
	if x != nil {
		return x.TransferToFeePayer
	}
	return nil
}
...
func (*RawMessage_MessageHeader) Descriptor() ([]byte, []int) {
	return file_Solana_proto_rawDescGZIP(), []int{15, 0}
}
...
func (*RawMessage_Instruction) Descriptor() ([]byte, []int) {
	return file_Solana_proto_rawDescGZIP(), []int{15, 1}
}
...
func (*RawMessage_MessageAddressTableLookup) Descriptor() ([]byte, []int) {
	return file_Solana_proto_rawDescGZIP(), []int{15, 2}
}
...
func (*RawMessage_MessageLegacy) Descriptor() ([]byte, []int) {
	return file_Solana_proto_rawDescGZIP(), []int{15, 3}
}
...
func (*RawMessage_MessageV0) Descriptor() ([]byte, []int) {
	return file_Solana_proto_rawDescGZIP(), []int{15, 4}
}
...
const file_Solana_proto_rawDesc = "" +
	...
	"references\x12I\n" +
	"\x10token_program_id\x18\t \x01(\x0e2\x1f.TW.Solana.Proto.TokenProgramIdR\x0etokenProgramId\"\xda\x02\n" +
	"\x17TokenTransferToFeePayer\x123\n" +
	"\x16fee_token_mint_address\x18\x01 \x01(\tR\x13feeTokenMintAddress\x12=\n" +
	"\x1bfee_recipient_token_address\x18\x02 \x01(\tR\x18feeRecipientTokenAddress\x12\x1d\n" +
	"\n" +
	"fee_amount\x18\x03 \x01(\x04R\tfeeAmount\x127\n" +
	"\x18fee_sender_token_address\x18\x04 \x01(\tR\x15feeSenderTokenAddress\x12!\n" +
	"\ffee_decimals\x18\x05 \x01(\rR\vfeeDecimals\x12P\n" +
	"\x14fee_token_program_id\x18\x06 \x01(\x0e2\x1f.TW.Solana.Proto.TokenProgramIdR\x11feeTokenProgramId\"\x88\x01\n" +
	...
	"\x05limit\x18\x02 \x01(\rR\x05limit\"\xff\x0e\n" +
	...
	"\x12priority_fee_limit\x18\x17 \x01(\v2!.TW.Solana.Proto.PriorityFeeLimitR\x10priorityFeeLimit\x12f\n" +
	"\x1btoken_transfer_to_fee_payer\x18\x18 \x01(\v2(.TW.Solana.Proto.TokenTransferToFeePayerR\x17tokenTransferToFeePayer\x12L\n" +
	"\x15transfer_to_fee_payer\x18\x19 \x01(\v2\x19.TW.Solana.Proto.TransferR\x12transferToFeePayerB\x12\n" +
...
var file_Solana_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_Solana_proto_goTypes = []any{
	...
	(*TokenTransferToFeePayer)(nil),              // 12: TW.Solana.Proto.TokenTransferToFeePayer
	(*CreateNonceAccount)(nil),                   // 13: TW.Solana.Proto.CreateNonceAccount
	(*WithdrawNonceAccount)(nil),                 // 14: TW.Solana.Proto.WithdrawNonceAccount
	(*AdvanceNonceAccount)(nil),                  // 15: TW.Solana.Proto.AdvanceNonceAccount
	(*PubkeySignature)(nil),                      // 16: TW.Solana.Proto.PubkeySignature
	(*RawMessage)(nil),                           // 17: TW.Solana.Proto.RawMessage
	(*DecodingTransactionOutput)(nil),            // 18: TW.Solana.Proto.DecodingTransactionOutput
	(*PriorityFeePrice)(nil),                     // 19: TW.Solana.Proto.PriorityFeePrice
	(*PriorityFeeLimit)(nil),                     // 20: TW.Solana.Proto.PriorityFeeLimit
	(*SigningInput)(nil),                         // 21: TW.Solana.Proto.SigningInput
	(*SigningOutput)(nil),                        // 22: TW.Solana.Proto.SigningOutput
	(*PreSigningOutput)(nil),                     // 23: TW.Solana.Proto.PreSigningOutput
	(*MessageSigningInput)(nil),                  // 24: TW.Solana.Proto.MessageSigningInput
	(*MessageSigningOutput)(nil),                 // 25: TW.Solana.Proto.MessageSigningOutput
	(*MessageVerifyingInput)(nil),                // 26: TW.Solana.Proto.MessageVerifyingInput
	(*RawMessage_MessageHeader)(nil),             // 27: TW.Solana.Proto.RawMessage.MessageHeader
	(*RawMessage_Instruction)(nil),               // 28: TW.Solana.Proto.RawMessage.Instruction
	(*RawMessage_MessageAddressTableLookup)(nil), // 29: TW.Solana.Proto.RawMessage.MessageAddressTableLookup
	(*RawMessage_MessageLegacy)(nil),             // 30: TW.Solana.Proto.RawMessage.MessageLegacy
	(*RawMessage_MessageV0)(nil),                 // 31: TW.Solana.Proto.RawMessage.MessageV0
	(common.SigningError)(0),                     // 32: TW.Common.Proto.SigningError
}
var file_Solana_proto_depIdxs = []int32{
	...
	0,  // 4: TW.Solana.Proto.TokenTransferToFeePayer.fee_token_program_id:type_name -> TW.Solana.Proto.TokenProgramId
	16, // 5: TW.Solana.Proto.RawMessage.signatures:type_name -> TW.Solana.Proto.PubkeySignature
	30, // 6: TW.Solana.Proto.RawMessage.legacy:type_name -> TW.Solana.Proto.RawMessage.MessageLegacy
	31, // 7: TW.Solana.Proto.RawMessage.v0:type_name -> TW.Solana.Proto.RawMessage.MessageV0
	17, // 8: TW.Solana.Proto.DecodingTransactionOutput.transaction:type_name -> TW.Solana.Proto.RawMessage
	32, // 9: TW.Solana.Proto.DecodingTransactionOutput.error:type_name -> TW.Common.Proto.SigningError
	2,  // 10: TW.Solana.Proto.SigningInput.transfer_transaction:type_name -> TW.Solana.Proto.Transfer
	3,  // 11: TW.Solana.Proto.SigningInput.delegate_stake_transaction:type_name -> TW.Solana.Proto.DelegateStake
	4,  // 12: TW.Solana.Proto.SigningInput.deactivate_stake_transaction:type_name -> TW.Solana.Proto.DeactivateStake
	5,  // 13: TW.Solana.Proto.SigningInput.deactivate_all_stake_transaction:type_name -> TW.Solana.Proto.DeactivateAllStake
	6,  // 14: TW.Solana.Proto.SigningInput.withdraw_transaction:type_name -> TW.Solana.Proto.WithdrawStake
	8,  // 15: TW.Solana.Proto.SigningInput.withdraw_all_transaction:type_name -> TW.Solana.Proto.WithdrawAllStake
	9,  // 16: TW.Solana.Proto.SigningInput.create_token_account_transaction:type_name -> TW.Solana.Proto.CreateTokenAccount
	10, // 17: TW.Solana.Proto.SigningInput.token_transfer_transaction:type_name -> TW.Solana.Proto.TokenTransfer
	11, // 18: TW.Solana.Proto.SigningInput.create_and_transfer_token_transaction:type_name -> TW.Solana.Proto.CreateAndTransferToken
	13, // 19: TW.Solana.Proto.SigningInput.create_nonce_account:type_name -> TW.Solana.Proto.CreateNonceAccount
	14, // 20: TW.Solana.Proto.SigningInput.withdraw_nonce_account:type_name -> TW.Solana.Proto.WithdrawNonceAccount
	15, // 21: TW.Solana.Proto.SigningInput.advance_nonce_account:type_name -> TW.Solana.Proto.AdvanceNonceAccount
	17, // 22: TW.Solana.Proto.SigningInput.raw_message:type_name -> TW.Solana.Proto.RawMessage
	1,  // 23: TW.Solana.Proto.SigningInput.tx_encoding:type_name -> TW.Solana.Proto.Encoding
	19, // 24: TW.Solana.Proto.SigningInput.priority_fee_price:type_name -> TW.Solana.Proto.PriorityFeePrice
	20, // 25: TW.Solana.Proto.SigningInput.priority_fee_limit:type_name -> TW.Solana.Proto.PriorityFeeLimit
	12, // 26: TW.Solana.Proto.SigningInput.token_transfer_to_fee_payer:type_name -> TW.Solana.Proto.TokenTransferToFeePayer
	2,  // 27: TW.Solana.Proto.SigningInput.transfer_to_fee_payer:type_name -> TW.Solana.Proto.Transfer
	32, // 28: TW.Solana.Proto.SigningOutput.error:type_name -> TW.Common.Proto.SigningError
	16, // 29: TW.Solana.Proto.SigningOutput.signatures:type_name -> TW.Solana.Proto.PubkeySignature
	32, // 30: TW.Solana.Proto.PreSigningOutput.error:type_name -> TW.Common.Proto.SigningError
	32, // 31: TW.Solana.Proto.MessageSigningOutput.error:type_name -> TW.Common.Proto.SigningError
	27, // 32: TW.Solana.Proto.RawMessage.MessageLegacy.header:type_name -> TW.Solana.Proto.RawMessage.MessageHeader
	28, // 33: TW.Solana.Proto.RawMessage.MessageLegacy.instructions:type_name -> TW.Solana.Proto.RawMessage.Instruction
	27, // 34: TW.Solana.Proto.RawMessage.MessageV0.header:type_name -> TW.Solana.Proto.RawMessage.MessageHeader
	28, // 35: TW.Solana.Proto.RawMessage.MessageV0.instructions:type_name -> TW.Solana.Proto.RawMessage.Instruction
	29, // 36: TW.Solana.Proto.RawMessage.MessageV0.address_table_lookups:type_name -> TW.Solana.Proto.RawMessage.MessageAddressTableLookup
...
func file_Solana_proto_init() {
	...
	file_Solana_proto_msgTypes[19].OneofWrappers = []any{
