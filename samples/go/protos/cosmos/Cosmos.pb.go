...
func (x *THORChainAsset) GetTrade() bool {
	if x != nil {
		return x.Trade
	}
	return false
...
func (x *THORChainAsset) GetSecured() bool {
	if x != nil {
		return x.Secured
	}
	return false
...
const file_Cosmos_proto_rawDesc = "" +
	...
	"\x0frevision_height\x18\x02 \x01(\x04R\x0erevisionHeight\"\x9c\x01\n" +
	...
	"\asecured\x18\x06 \x01(\bR\asecured\"z\n" +
	"\rTHORChainCoin\x125\n" +
