...
describe('CoinAddressDerivation', () => {
    ...
    const runDerivationChecks = (coin: CoinType, address: string) => {
        switch (coin) {
            ...
            case CoinType.GO: expect('0x5940ce4A14210d4Ccd0ac206CE92F21828016aC2').to.equal(address); break;
            ...
            case CoinType.IOST: expect('TyEiLWJ2R5fN12dCH5i6fmALoYUsn49CqbRhZU96R1GD').to.equal(address); break;
