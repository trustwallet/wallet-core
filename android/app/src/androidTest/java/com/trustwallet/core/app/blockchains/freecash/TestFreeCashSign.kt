...
class TestFreeCashSign {
    ...
    @Test
    fun testSignSchnorr() {
        val privateKey = PrivateKey(Numeric.hexStringToByteArray("afeefca74d9a325cf1d6b6911d61a65c32afa8e02bd5e78e2e4ac2910bab45f5"))
        val publicKey = privateKey.getPublicKeySecp256k1(true)

        val message = "hello schnorr".toByteArray(Charsets.UTF_8)

        val sig = privateKey.signSchnorr(message,Curve.SECP256K1)
