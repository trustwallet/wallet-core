...
@Test
    ...
    fun testSigningJSON() {
        ...
        val expectedResult = """{"mode":"block","tx":{"fee":{"amount":[{"amount":"5000","denom":"ubnt"}],"gas":"200000"},"memo":"Testing","msg":[{"type":"cosmos-sdk/MsgSend","value":{"amount":[{"amount":"995000","denom":"ubnt"}],"from_address":"$myAddress","to_address":"$toAddress"}}],"signatures":[{"pub_key":{"type":"tendermint/PubKeySecp256k1","value":"AlcobsPzfTNVe7uqAAsndErJAjqplnyudaGB0f+R+p3F"},"signature":"CXtJaa+NFM0jxrQJ9zBToxjnFqQTv2mUPOzYX2hp/gAFRvyUx7rQprhMgmO/sila0CaQCteynNuzdV1j6836Ew=="}]}}"""
