...
class TestBitcoinSigning {
    ...
    fun testSignBrc20CommitLiveSample() {
        ...
        val output = AnySigner.plan(input.build(), BITCOIN, SigningOutput.parser())
    ...
    fun testSignNftInscriptionCommit() {
        ...
        assertEquals(Numeric.toHexString(output.encoded.toByteArray()), "")
