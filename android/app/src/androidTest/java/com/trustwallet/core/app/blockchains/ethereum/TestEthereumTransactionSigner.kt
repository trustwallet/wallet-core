...
class TestEthereumTransactionSigner {
    ...
    // ERC4337
    @Test
    fun testERC4337TransactionSigningAccountNotDeployed() {
        val signingInput = Ethereum.SigningInput.newBuilder()
        signingInput.apply {
            ...
            userOperation = Ethereum.UserOperation.newBuilder().apply {
                ...
                sender = "0x5A87209b755781cF65fEeEdd3855ade0317f4a92"
                initCode = "0x21cc27d7db4fa19857a3702653a7a67ee30ca620"
        ...
        assertEquals(output.pre_hash.toStringUtf8(), "0xdasfasd");
    ...
    @Test
    fun testERC4337TransactionSigningAccountDeployed() {
        val signingInput = Ethereum.SigningInput.newBuilder()
        signingInput.apply {
            privateKey = ByteString.copyFrom(PrivateKey("0xf9fb27c90dcaa5631f373330eeef62ae7931587a19bd8215d0c2addf28e439c8".toHexByteArray()).data())
            chainId = ByteString.copyFrom("0x5".toHexByteArray())
    ...
    @Test
    fun testERC4337ERC20TransferAccountDeployed() {
        val signingInput = Ethereum.SigningInput.newBuilder()
        signingInput.apply {
            privateKey = ByteString.copyFrom(PrivateKey("0xf9fb27c90dcaa5631f373330eeef62ae7931587a19bd8215d0c2addf28e439c8".toHexByteArray()).data())
            chainId = ByteString.copyFrom("0x5".toHexByteArray())
    ...
    @Test
    fun testERC4337ERC20ApproveAccountDeployed() {
        val signingInput = Ethereum.SigningInput.newBuilder()
        signingInput.apply {
            privateKey = ByteString.copyFrom(PrivateKey("0xf9fb27c90dcaa5631f373330eeef62ae7931587a19bd8215d0c2addf28e439c8".toHexByteArray()).data())
            chainId = ByteString.copyFrom("0x5".toHexByteArray())
    ...
    @Test
    fun testERC4337ERC721TransferAccountDeployed() {
        val signingInput = Ethereum.SigningInput.newBuilder()
        signingInput.apply {
            privateKey = ByteString.copyFrom(PrivateKey("0xf9fb27c90dcaa5631f373330eeef62ae7931587a19bd8215d0c2addf28e439c8".toHexByteArray()).data())
            chainId = ByteString.copyFrom("0x5".toHexByteArray())
    ...
    @Test
    fun testERC4337ERC1155TransferAccountDeployed() {
        val signingInput = Ethereum.SigningInput.newBuilder()
        signingInput.apply {
            privateKey = ByteString.copyFrom(PrivateKey("0xf9fb27c90dcaa5631f373330eeef62ae7931587a19bd8215d0c2addf28e439c8".toHexByteArray()).data())
            chainId = ByteString.copyFrom("0x5".toHexByteArray())
            ...
            userOperation = Ethereum.UserOperation.newBuilder().apply {
                entryPoint = "0x1306b01bC3e4AD202612D3843387e94737673F53"
                sender = "0x76627b8D1E01fAF0C73B69625BC1fCb8FA19a2AD"
