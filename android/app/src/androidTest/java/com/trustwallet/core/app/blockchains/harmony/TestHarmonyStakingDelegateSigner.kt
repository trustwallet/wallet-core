...
class TestHarmonyStakingDelegateSigner {
    ...
    fun testHarmonyStakingTransactionCreateValidatorSigning() {
        ...
        val sign: Harmony.SigningOutput = HarmonySigner.signStakingCreateValidator(signingInput.build())
    ...
    fun testHarmonyStakingTransactionEditValidatorSigning() {
        ...
        val sign: Harmony.SigningOutput = HarmonySigner.signStakingEditValidator(signingInput.build())
    ...
    fun testHarmonyStakingTransactionDelegateSigning() {
        ...
        val sign: Harmony.SigningOutput = HarmonySigner.signStakingDelegate(signingInput.build())
    ...
    fun testHarmonyStakingTransactionUndelegateSigning() {
        ...
        val sign: Harmony.SigningOutput = HarmonySigner.signStakingUndelegate(signingInput.build())
    ...
    fun testHarmonyStakingTransactionCollectRewardsSigning() {
        ...
        val sign: Harmony.SigningOutput = HarmonySigner.signStakingCollectRewards(signingInput.build())
