...
class TestNULSSigner {
    ...
    fun NULSTransactionSigning() { 
        val signingInput = NULS.SigningInput.newBuilder()
            .setPrivateKey(ByteString.copyFrom("9ce21dad67e0f0af2599b41b515a7f7018059418bab892a7b68f283d489abc4b".toHexByteArray()))
        ...
        assertEquals(output.encoded.toByteArray(),
