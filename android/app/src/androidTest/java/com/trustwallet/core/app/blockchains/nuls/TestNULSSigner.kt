...
class TestNULSSigner {
    ...
    fun NULSTransactionSigning() { 
        val signingInput = NULS.SigningInput.newBuilder()
            .setPrivateKey(Numeric.hexStringToByteArray("9ce21dad67e0f0af2599b41b515a7f7018059418bab892a7b68f283d489abc4b"))
            ...
            .setChainId(1)
            .setIdassetsId(1)
            .setNonce(ByteString.copyFrom("0x0000000000000000".toHexByteArray()))
            .setRemark("")
