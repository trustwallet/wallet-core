...
"""
        assertEquals(out.json, expectedJson)
    }
    ...
    fun testAddPubAddress() {
        ...
        val addAddrAction = FIO.Action.AddPubAddress.newBuilder()
            .setFioAddress("adam@fiotestnet")
            .setPublicAddresses(0, FIO.PublicAddress.newBuilder().setTokenCode("BTC").setAddress("bc1qvy4074rggkdr2pzw5vpnn62eg0smzlxwp70d7v"))
            .setPublicAddresses(0, FIO.PublicAddress.newBuilder().setTokenCode("ETH").setAddress("0xce5cB6c92Da37bbBa91Bd40D4C9D4D724A3a8F51"))
            .setPublicAddresses(0, FIO.PublicAddress.newBuilder().setTokenCode("BNB").setAddress("bnb1ts3dg54apwlvr9hupv2n0j6e46q54znnusjk9s"))
            .setMaxFee(0)
            .setTpid("rewards@wallet")
        val action = FIO.Action.newBuilder()
