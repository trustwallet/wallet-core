...
package com.trustwallet.core.app.blockchains.conflux
...
class TestConfluxAddress {
    ...
    fun testAddress() {
        ...
        val address = AnyAddress(pubkey, CoinType.CONFLUX)
        val expected = AnyAddress("0xA3Dcd899C0f3832DFDFed9479a9d828c6A4EB2A7", CoinType.CONFLUX)
