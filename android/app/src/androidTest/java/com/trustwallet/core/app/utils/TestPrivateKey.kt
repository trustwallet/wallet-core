...
class TestPrivateKey {
    ...
    @Test
    fun testCreate() {
        var privateKey = PrivateKey(Curve.SECP256K1)
    ...
    fun testCreateStarkKeySigning() {
        ...
        val signature = privateKey.sign(digest)
    ...
    fun testInvalid() {
        ...
        try {
            privateKey = PrivateKey(bytes, Curve.SECP256K1)
        } catch (ex: Exception) {
        }
    ...
    fun testGetPublicKeyCoinType() {
        ...
        val privateKey = PrivateKey(privateKeyData, Curve.SECP256K1)
