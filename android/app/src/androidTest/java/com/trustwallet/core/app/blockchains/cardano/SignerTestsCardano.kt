...
class TestCardanoSigner {
    ...
    fun testSignTransaction() {
        ...
        val sign: Cardano.SigningOutput = CardanoSigner.sign(signingInput.build())
        ...
        assertEquals(sign.transactionId.toByteArray().toHex(), "4374315285f5af17c5fd37d78bcaa94534968e925c06e293e10d2348d9420fac")
