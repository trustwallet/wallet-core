...
class CoinAddressDerivationTests {
    ...
    private fun runDerivationChecks(coin: CoinType, address: String?) = when (coin) {
        ...
        ETHEREUM, SMARTCHAIN, POLYGON, OPTIMISM, ARBITRUM, HECO, AVALANCHEC, XDAI,
        FANTOM, RONIN, CELO -> assertEquals("0x8f348F300873Fd5DA36950B2aC75a26584584feE", address)
        CLASSIC -> assertEquals("0x078bA3228F3E6C08bEEac9A005de0b7e7089aD1c", address)
        ...
        DOGE -> assertEquals("DJRFZNg8jkUtjcpo2zJd92FUAzwRjitw6f", address)
        ...
        BAND -> assertEquals("band1624hqgend0s3d94z68fyka2y5jak6vd7u0l50r", address)
