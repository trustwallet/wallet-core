...
class CoinAddressDerivationTests {
    ...
    private fun runDerivationChecks(coin: CoinType, address: String?) = when (coin) {
        ...
        IOST -> assertEquals("AjvLqiYRd2vbRwqn3uXoUYMpZ3qZ2r57MYUNhYiKu41w", address)
        ...
        EOSIO -> assertEquals("EOS6hs8sRvGSzuQtq223zwJipMzqTJpXUVjyvHPvPwBSZWWrJTJkg", address)
    }
}
