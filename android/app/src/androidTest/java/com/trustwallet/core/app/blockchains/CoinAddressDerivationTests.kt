...
class CoinAddressDerivationTests {
    ...
    private fun runDerivationChecks(coin: CoinType, address: String?) = when (coin) {
        ...
        AURORA, EVMOS, MOONRIVER, MOONBEAM, KAVAEVM, KLAYTN, METER, OKXCHAIN, POLYGONZKEVM, SCROLL, PLAYA3ULL -> assertEquals("0x8f348F300873Fd5DA36950B2aC75a26584584feE", address)
