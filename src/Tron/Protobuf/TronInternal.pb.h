...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_TronInternal_2eproto 
...
class Transaction_Contract : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.Transaction.Contract) */ {
 public:
  ...
  inline Transaction_Contract* New() const final {
    return CreateMaybeMessage<Transaction_Contract>(NULL);
  }
 ...
 private:
  ...
  friend struct ::protobuf_TronInternal_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class Transaction_raw : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.Transaction.raw) */ {
 public:
  ...
  inline Transaction_raw* New() const final {
    return CreateMaybeMessage<Transaction_raw>(NULL);
  }
...
class BlockHeader_raw : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.BlockHeader.raw) */ {
 public:
  ...
  inline BlockHeader_raw* New() const final {
    return CreateMaybeMessage<BlockHeader_raw>(NULL);
  }
...
inline const ::google::protobuf::Any& Transaction_Contract::_internal_parameter() const {
  return *parameter_;
}
