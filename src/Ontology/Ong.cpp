...
Transaction Ong::transfer(const Account &from, std::string &to, uint64_t amount, const Account &payer, uint64_t gasPrice, uint64_t gasLimit) {
    ...
    auto invokeCode = ParamsBuilder::buildNativeInvokeCode(ongContract, 0x00, "transfer", args);
