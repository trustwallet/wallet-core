...
inline const uint256_t gStarkCurveA(1);
inline const uint256_t gStarkCurveB("3141592653589793238462643383279502884197169399375105820974944592307816406665");
inline const uint256_t gStarkCurveN("3618502788666131213697322783095070105526743751716087489154079457884512865583");
inline const uint256_t gStarkCurveP("3618502788666131213697322783095070105623107215331596699973092056135872020481");
