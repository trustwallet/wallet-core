...
using Signature = TW::Ethereum::Signature;
using TransactionBase = TW::Ethereum::TransactionBase;

namespace TW::NewChain {
...
struct TWNewChainSigner {
    TW::NewChain::Signer impl;
};
