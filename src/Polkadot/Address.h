...
class Address: public SS58Address {
  public:
    ...
    /// Initializes a Polkadot address with a public key and a given prefixNetwork.
    explicit Address(const PublicKey& publicKey, std::uint32_t prefixNetwork): SS58Address(publicKey, prefixNetwork) {}
};
} // namespace TW::Polkadot
