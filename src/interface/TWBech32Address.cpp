...
bool TWBech32AddressEqual(struct TWBech32Address* _Nonnull lhs,
                          struct TWBech32Address* _Nonnull rhs) {
...
struct TWBech32Address* _Nullable TWBech32AddressCreateWithData(enum TWHRP hrp,
...
struct TWBech32Address* _Nonnull TWBech32AddressCreateWithPublicKey(
...
TWData* _Nonnull TWBech32AddressWitnessProgram(struct TWBech32Address* _Nonnull address) {
    return TWDataCreateWithBytes(address->impl.witnessProgram.data(),
                                 address->impl.witnessProgram.size());
}
