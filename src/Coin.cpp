...
#include "Telos/Entry.h" // TODO remove if the blockchain already exists, or just remove this comment if not
...
Telos::Entry TelosDP; // TODO remove if the blockchain already exists, or just remove this comment if not
...
CoinEntry* coinDispatcher(TWCoinType coinType) {
    ...
    switch (blockchain) {
        ...
        case TWBlockchainTelos: entry = &TelosDP; break; // TODO remove if the blockchain already exists, or just remove this comment if not
