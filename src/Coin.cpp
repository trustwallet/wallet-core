...
#include "MeterMetaStableGasToken/Entry.h"
...
MeterMetaStableGasToken::Entry MeterMetaStableGasTokenDP;
...
CoinEntry* coinDispatcher(TWCoinType coinType) {
    ...
    switch (coinType) {
        ...
        case TWCoinTypeMeterMetaStableGasToken: entry = &MeterMetaStableGasTokenDP; break;
