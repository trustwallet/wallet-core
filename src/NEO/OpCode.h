...
//static const uint8_t OP_EQUALVERIFY{0x88}; // Same as OP_EQUAL, but runs OP_VERIFY afterward.
//static const uint8_t OP_RESERVED1{0x89}; // Transaction is invalid unless occuring in an unexecuted OP_IF branch
//static const uint8_t OP_RESERVED2{0x8A}; // Transaction is invalid unless occuring in an unexecuted OP_IF branch
