...
const std::string NEAR_PREFIX_SEND_COIN_MESSAGE = "NEAR-sdk/MsgSend";
const std::string NEAR_PREFIX_STAKE_MESSAGE = "NEAR-sdk/MsgDelegate";
const std::string NEAR_PREFIX_UNSTAKE_MESSAGE = "NEAR-sdk/MsgUndelegate";
const std::string NEAR_PREFIX_WITHDRAW_STAKE_MESSAGE = "NEAR-sdk/MsgWithdrawDelegationReward";
const std::string NEAR_PREFIX_TRANSACTION = "auth/StdTx";
const std::string NEAR_PREFIX_PUBLIC_KEY = "tendermint/PubKeySecp256k1";
...
static json signatureJSON(const Signature& signature) {
    ...
    jsonSignature["pub_key"]["type"] = NEAR_PREFIX_PUBLIC_KEY;
...
json TW::NEAR::signaturePreimageJSON(const SigningInput& input) {
    json jsonForSigning;
...
json TW::NEAR::transactionJSON(const Transaction& transaction, std::string type_prefix) {
    json jsonTx;
