...
const std::string AMINO_PREFIX_SEND_COIN_MESSAGE = "NEAR-sdk/MsgSend";
const std::string AMINO_PREFIX_STAKE_MESSAGE = "NEAR-sdk/MsgDelegate";
const std::string AMINO_PREFIX_UNSTAKE_MESSAGE = "NEAR-sdk/MsgUndelegate";
const std::string AMINO_PREFIX_WITHDRAW_STAKE_MESSAGE = "NEAR-sdk/MsgWithdrawDelegationReward";
