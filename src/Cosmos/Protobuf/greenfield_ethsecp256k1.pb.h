...
#ifndef GOOGLE_PROTOBUF_INCLUDED_greenfield_5fethsecp256k1_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_greenfield_5fethsecp256k1_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_greenfield_5fethsecp256k1_2eproto
...
struct TableStruct_greenfield_5fethsecp256k1_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_greenfield_5fethsecp256k1_2eproto;
namespace cosmos {
namespace crypto {
namespace eth {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::cosmos::crypto::eth::ethsecp256k1::PubKey* Arena::CreateMaybeMessage<::cosmos::crypto::eth::ethsecp256k1::PubKey>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace cosmos {
namespace crypto {
namespace eth {
...
class PubKey final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cosmos.crypto.eth.ethsecp256k1.PubKey) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "cosmos.crypto.eth.ethsecp256k1.PubKey";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:cosmos.crypto.eth.ethsecp256k1.PubKey)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_greenfield_5fethsecp256k1_2eproto;
};
// ===================================================================
...
inline const std::string& PubKey::key() const {
  // @@protoc_insertion_point(field_get:cosmos.crypto.eth.ethsecp256k1.PubKey.key)
...
void PubKey::set_key(ArgT0&& arg0, ArgT... args) {
 ...
 key_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:cosmos.crypto.eth.ethsecp256k1.PubKey.key)
}
inline std::string* PubKey::mutable_key() {
  std::string* _s = _internal_mutable_key();
  // @@protoc_insertion_point(field_mutable:cosmos.crypto.eth.ethsecp256k1.PubKey.key)
  return _s;
}
...
inline std::string* PubKey::release_key() {
  // @@protoc_insertion_point(field_release:cosmos.crypto.eth.ethsecp256k1.PubKey.key)
...
inline void PubKey::set_allocated_key(std::string* key) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cosmos.crypto.eth.ethsecp256k1.PubKey.key)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_greenfield_5fethsecp256k1_2eproto
