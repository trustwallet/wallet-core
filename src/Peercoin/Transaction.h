...
struct Transaction {
    ...
    Transaction(int32_t version, uint32_t timestamp, uint32_t lockTime, TW::Hash::Hasher hasher = TW::Hash::sha256d)
...
struct TWPeercoinTransaction {
    TW::Peercoin::Transaction impl;
};
