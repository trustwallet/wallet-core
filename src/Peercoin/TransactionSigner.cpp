...
Result<void> TransactionSigner<Transaction>::sign(Script script, size_t index,
                                                  const Peercoin::Proto::UnspentTransaction& utxo) {
    Script redeemScript;
...
Result<std::vector<Data>> TransactionSigner<Transaction>::signStep(
    Script script, size_t index, const Peercoin::Proto::UnspentTransaction& utxo, uint32_t version) {
...
template class TW::Peercoin::TransactionSigner<Peercoin::Transaction>;
