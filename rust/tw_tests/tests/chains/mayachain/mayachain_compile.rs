...
use crate::chains::mayachain::test_cases::send_fd0445af::{
...
#[test]
fn test_any_signer_compile_mayachain() {
    ...
    let preimage_data = TWDataHelper::wrap(unsafe {
        tw_transaction_compiler_pre_image_hashes(CoinType::MAYAChain as u32, input_data.ptr())
    })
    .to_vec()
