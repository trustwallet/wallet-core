...
fn test_get_diamond_cut_code_with_not_aligned_init_data() {
    ...
    let diamond_cut_code = get_diamond_cut_code(&input).expect("Failed to get diamond cut code");
    assert_eq!(hex::encode(diamond_cut_code, true), "");
}
