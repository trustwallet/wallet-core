    ...
    pub fn derive_from_path(&self, path: &str) -> Result<Self> {
        ...
        match self {
            ...
            HDNodePublic::Ed25519ExtendedCardano(xpub, _) => {
                ...
                let xpub2 = xpub.derive_from_path(&staking_path)?;
