// Automatically generated rust module for 'Aeternity.proto' file
    ...
    fn from_reader(r: &mut BytesReader, bytes: &'a [u8]) -> Result<Self> {
        ...
        while !r.is_eof() {
            match r.next_tag(bytes) {
                ...
                Ok(42) => msg.payload = r.read_string(bytes).map(Cow::Borrowed)?,
...
impl<'a> MessageWrite for SigningInput<'a> {
    ...
    fn write_message<W: WriterBackend>(&self, w: &mut Writer<W>) -> Result<()> {
        ...
        if self.payload != "" { w.write_with_tag(42, |w| w.write_string(&**&self.payload))?; }
