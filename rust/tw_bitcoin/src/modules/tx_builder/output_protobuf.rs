...
//             RecipientType::builder(ref builder) => match builder {
...
//     ) -> SigningResult<TransactionOutput> {
//         let pubkey_hash = pubkey_hash_from_proto(pubkey_or_hash).context("P2PKH builder")?;
...
//         pubkey_or_hash: &Proto::PublicKeyOrHash,
//     ) -> SigningResult<TransactionOutput> {
//         let pubkey_hash = pubkey_hash_from_proto(pubkey_or_hash).context("P2WPKH builder")?;
...
//         addr: &LegacyAddress,
//     ) -> SigningResult<TransactionOutput> {
//         let script_pubkey = conditions::new_pay_to_legacy_addr(
//             self.chain_info.p2pkh_prefix,
//             self.chain_info.p2sh_prefix,
//             addr,
//         )?;
//         Ok(self.prepare_builder().custom_script_pubkey(script_pubkey))
//     }
//
