...
impl BRC20Deploy {
    ...
    pub fn from_payload(
        ...
        let inscription =
            new_ordinals_inscription(MIME, &serde_json::to_vec(&data).unwrap(), recipient)?;
...
#[derive(Serialize, Deserialize)]
pub struct BRC20TransferPayload {
    pub p: &'static str,
    pub op: &'static str,
    pub tick: String,
    pub amt: usize,
