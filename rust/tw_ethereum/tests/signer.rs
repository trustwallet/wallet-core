...
#[test]
fn test_user_operation_transfer_account_deployed() {
    let private_key =
    ...
    let transfer = Proto::mod_Transaction::Transfer {
        amount: U256::encode_le_compact(0x23_86f2_6fc1_0000),
        data: Cow::default(),
    };
    let user_op = Proto::UserOperation {
        ...
        pre_verification_gas: U256::encode_le_compact(0xb708),
        verification_gas_limit: U256::encode_le_compact(0x186a0),
        paymaster_and_data: Cow::default(),
    };

    let input = Proto::SigningInput {
        chain_id: U256::encode_le_compact(97),
        nonce: U256::encode_le_compact(2),
        tx_mode: Proto::TransactionMode::UserOp,
        gas_price: Cow::default(),
        gas_limit: U256::encode_le_compact(0x186A0),
        max_fee_per_gas: U256::encode_le_compact(0x1_a339_c9e9),
        max_inclusion_fee_per_gas: U256::encode_le_compact(0x1_a339_c9e9),
...
#[test]
fn test_user_operation_transfer_account_not_deployed() {
    let private_key =
        hex::decode("0x3c90badc15c4d35733769093d3733501e92e7f16e101df284cee9a310d36c483").unwrap();
    ...
    let user_op = Proto::UserOperation {
        ...
        pre_verification_gas: U256::encode_le_compact(0xb708),
        verification_gas_limit: U256::encode_le_compact(0x2D_C6C0),
        paymaster_and_data: Cow::default(),
    };

    let input = Proto::SigningInput {
        chain_id: U256::encode_le_compact(97),
        nonce: U256::encode_le_compact(0),
        tx_mode: Proto::TransactionMode::UserOp,
        gas_price: Cow::default(),
        gas_limit: U256::encode_le_compact(0x26_25A0),
        max_fee_per_gas: U256::encode_le_compact(0x1_a339_c9e9),
        max_inclusion_fee_per_gas: U256::encode_le_compact(0x1_a339_c9e9),
        to_address: "0x61061fCAE11fD5461535e134EfF67A98CFFF44E9".into(),
        private_key: private_key.into(),
...
// // https://testnet.bscscan.com/tx/0xea1f5cddc0653e116327cbcb3bc770360a642891176eff2ec69c227e46791c31
#[test]
fn test_user_operation_batched_account_deployed() {
    let private_key =
        hex::decode("0x3c90badc15c4d35733769093d3733501e92e7f16e101df284cee9a310d36c483").unwrap();
    ...
    let user_op = Proto::UserOperation {
        ...
        pre_verification_gas: U256::encode_le_compact(0xDAFC),
        verification_gas_limit: U256::encode_le_compact(0x07_F7C4),
        paymaster_and_data: Cow::default(),
    };

    let input = Proto::SigningInput {
        chain_id: U256::encode_le_compact(97),
        nonce: U256::encode_le_compact(3),
        tx_mode: Proto::TransactionMode::UserOp,
        gas_price: Cow::default(),
        gas_limit: U256::encode_le_compact(0x01_5A61),
        max_fee_per_gas: U256::encode_le_compact(0x02_540B_E400),
        max_inclusion_fee_per_gas: U256::encode_le_compact(0x02_540B_E400),
