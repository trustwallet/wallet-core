...
impl CoinEntry for RippleEntry {
    ...
    fn preimage_hashes(
        ...
        RippleCompiler::preimage_hashes(coin, input)
    }
    ...
    fn compile(
        ...
        RippleCompiler::compile(coin, input, signatures, public_keys)
    }
}
