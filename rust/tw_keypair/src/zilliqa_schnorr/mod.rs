...
mod tests {
    ...
    fn test_public_key() {
        ...
        assert_eq!(hex::encode(public_key.to_vec(), false), "0399c6f51ad6f98c9c583f8e92bb7758ab2ca9a04110c0a1126ec43e5453d196c1");
    }
    ...
    fn test_verify_invalid() {
        ...
        assert!(!private_key.public().verify(verify_sig, hash_to_sign.to_vec()));
    }
}