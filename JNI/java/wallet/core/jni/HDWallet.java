...
public class HDWallet {
    ...
    public static native PublicKey getPublicKeyFromExtended(String extended, CoinType coin, HDVersion versionPublic, HDVersion versionPrivate, int change, int address);
