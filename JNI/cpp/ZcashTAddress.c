...
jbyteArray JNICALL Java_com_wallet_crypto_trustapp_jni_ZcashTAddress_initWithString(JNIEnv *env, jclass thisClass, jstring string) {
...
jbyteArray JNICALL Java_com_wallet_crypto_trustapp_jni_ZcashTAddress_initWithData(JNIEnv *env, jclass thisClass, jbyteArray data) {
    jbyteArray array = (*env)->NewByteArray(env, sizeof(struct TWZcashTAddress));
    jbyte* bytesBuffer = (*env)->GetByteArrayElements(env, array, NULL);
    struct TWZcashTAddress *instance = (struct TWZcashTAddress *) bytesBuffer;
...
jbyteArray JNICALL Java_com_wallet_crypto_trustapp_jni_ZcashTAddress_initWithPublicKey(JNIEnv *env, jclass thisClass, jobject publicKey, jchar prefix) {
    jbyteArray array = (*env)->NewByteArray(env, sizeof(struct TWZcashTAddress));
    jbyte* bytesBuffer = (*env)->GetByteArrayElements(env, array, NULL);
    struct TWZcashTAddress *instance = (struct TWZcashTAddress *) bytesBuffer;
...
jboolean JNICALL Java_com_wallet_crypto_trustapp_jni_ZcashTAddress_equals(JNIEnv *env, jclass thisClass, jobject lhs, jobject rhs) {
...
jboolean JNICALL Java_com_wallet_crypto_trustapp_jni_ZcashTAddress_isValid(JNIEnv *env, jclass thisClass, jbyteArray data) {
    TWData *dataData = TWDataCreateWithJByteArray(env, data);
...
jboolean JNICALL Java_com_wallet_crypto_trustapp_jni_ZcashTAddress_isValidString(JNIEnv *env, jclass thisClass, jstring string) {
    TWString *stringString = TWStringCreateWithJString(env, string);
...
jstring JNICALL Java_com_wallet_crypto_trustapp_jni_ZcashTAddress_description(JNIEnv *env, jobject thisObject) {
...
jbyteArray JNICALL Java_com_wallet_crypto_trustapp_jni_ZcashTAddress_data(JNIEnv *env, jobject thisObject) {
    jclass thisClass = (*env)->GetObjectClass(env, thisObject);
    jfieldID bytesFieldID = (*env)->GetFieldID(env, thisClass, "bytes", "[B");
    jbyteArray bytesArray = (*env)->GetObjectField(env, thisObject, bytesFieldID);
    jbyte* bytesBuffer = (*env)->GetByteArrayElements(env, bytesArray, NULL);
