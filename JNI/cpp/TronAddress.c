...
jlong JNICALL Java_wallet_core_jni_TronAddress_nativeCreateWithPublicKey(JNIEnv* env,
    ...
    struct TWPublicKey* publicKeyInstance =
        (struct TWPublicKey*)(*env)->GetLongField(env, publicKey, publicKeyHandleFieldID);
...
jboolean JNICALL Java_wallet_core_jni_TronAddress_equals(JNIEnv* env, jclass thisClass, jobject lhs,
    ...
    struct TWTronAddress* lhsInstance =
        (struct TWTronAddress*)(*env)->GetLongField(env, lhs, lhsHandleFieldID);
    jclass rhsClass = (*env)->GetObjectClass(env, rhs);
    jfieldID rhsHandleFieldID = (*env)->GetFieldID(env, rhsClass, "nativeHandle", "J");
    struct TWTronAddress* rhsInstance =
        (struct TWTronAddress*)(*env)->GetLongField(env, rhs, rhsHandleFieldID);
...
jstring JNICALL Java_wallet_core_jni_TronAddress_description(JNIEnv* env, jobject thisObject) {
    ...
    struct TWTronAddress* instance =
        (struct TWTronAddress*)(*env)->GetLongField(env, thisObject, handleFieldID);
