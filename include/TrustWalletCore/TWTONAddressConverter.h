...
TW_EXPORT_STATIC_METHOD TWString *_Nullable TWTONAddressConverterToBoc(TWString *_Nonnull address);
...
TW_EXPORT_STATIC_METHOD TWString *_Nullable TWTONAddressConverterFromBoc(TWString *_Nonnull boc);
...
TW_EXPORT_STATIC_METHOD TWString *_Nullable TWTONAddressConverterToUserFriendly(TWString *_Nonnull address, bool bounceable, bool testnet);
