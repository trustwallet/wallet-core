...
describe("Cardano", () => {
    ...
    it("test signTransferWithAuxiliaryData", () => {
        const { AnySigner, CoinType, HexCoding, Hash } = globalThis.core;

        const privateKeyData = HexCoding.decode("");
        const fromAddress = "addr1qy5eme9r6frr0m6q2qpncg282jtrhq5lg09uxy2j0545hj8rv7v2ntdxuv6p4s3eq4lqzg39lewgvt6fk5kmpa0zppesufzjud"
        const toAddress = "addr1qy9wjfn6nd8kak6dd8z53u7t5wt9f4lx0umll40px5hnq05avwcsq5r3ytdp36wttzv4558jaq8lvhgqhe3y8nuf5xrquju7z4"

        // Example auxiliary data (CIP-20 memo). wallet-core treats it as opaque CBOR bytes.
        const auxiliaryData = HexCoding.decode("a11902a2a1636d7367817348656c6c6f2066726f6d2056756c7469736967");
        const auxiliaryDataHash = Hash.blake2b(auxiliaryData, 32);

        const utxo = TW.Cardano.Proto.TxInput.create({
            outPoint: TW.Cardano.Proto.OutPoint.create({
                txHash: HexCoding.decode("ee414d635b3bc67831907354d274a31174664777c57c21ae923b9459e5644840"),
                outputIndex: new Long(0),
            }),
            address: fromAddress,
            amount: new Long(3000000),
        });
        ...
        const encodedHex = HexCoding.encode(output.encoded);
        // The transaction body commits the blake2b-256 hash of the auxiliary data (body key 7).
        assert.include(encodedHex, HexCoding.encode(auxiliaryDataHash).slice(2));
        // The signed transaction carries the auxiliary data bytes, not a null placeholder.
        assert.include(encodedHex, "a11902a2a1636d7367817348656c6c6f2066726f6d2056756c7469736967");
    });
});
