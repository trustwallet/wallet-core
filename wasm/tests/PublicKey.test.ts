...
describe("PublicKey", () => {
  ...
  it("test sign, verify and recover", () => {
    ...
    const privKeyData = HexCoding.decode('afeefca74d9a325cf1d6b6911d61a65c32afa8e02bd5e78e2e4ac2910bab45f5');
    const messageDigest = HexCoding.decode('0001020304050607080910111213141519171819202122232425262728293031');

    const privkey = PrivateKey.createWithData(privKeyData);
