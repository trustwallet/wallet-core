...
(function (CoinType) {
    ...
    CoinType[CoinType["viacoin"] = 14] = "viacoin";
    CoinType[CoinType["groestlcoin"] = 17] = "groestlcoin";
    CoinType[CoinType["digibyte"] = 20] = "digibyte";
    CoinType[CoinType["monacoin"] = 22] = "monacoin";
    CoinType[CoinType["decred"] = 42] = "decred";
    CoinType[CoinType["ethereum"] = 60] = "ethereum";
    CoinType[CoinType["classic"] = 61] = "classic";
    CoinType[CoinType["icon"] = 74] = "icon";
    CoinType[CoinType["cosmos"] = 118] = "cosmos";
    CoinType[CoinType["zcash"] = 133] = "zcash";
    CoinType[CoinType["zcoin"] = 136] = "zcoin";
    CoinType[CoinType["ripple"] = 144] = "ripple";
    CoinType[CoinType["bitcoincash"] = 145] = "bitcoincash";
    CoinType[CoinType["stellar"] = 148] = "stellar";
    CoinType[CoinType["bitcoingold"] = 156] = "bitcoingold";
    CoinType[CoinType["nano"] = 165] = "nano";
    CoinType[CoinType["ravencoin"] = 175] = "ravencoin";
    CoinType[CoinType["poa"] = 178] = "poa";
    CoinType[CoinType["eos"] = 194] = "eos";
    CoinType[CoinType["tron"] = 195] = "tron";
    CoinType[CoinType["fio"] = 235] = "fio";
    CoinType[CoinType["nimiq"] = 242] = "nimiq";
    CoinType[CoinType["algorand"] = 283] = "algorand";
    CoinType[CoinType["iotex"] = 304] = "iotex";
    CoinType[CoinType["zilliqa"] = 313] = "zilliqa";
    CoinType[CoinType["terra"] = 330] = "terra";
    CoinType[CoinType["polkadot"] = 354] = "polkadot";
    CoinType[CoinType["ton"] = 396] = "ton";
    CoinType[CoinType["near"] = 397] = "near";
    CoinType[CoinType["aion"] = 425] = "aion";
    CoinType[CoinType["kusama"] = 434] = "kusama";
    CoinType[CoinType["aeternity"] = 457] = "aeternity";
    CoinType[CoinType["kava"] = 459] = "kava";
    CoinType[CoinType["filecoin"] = 461] = "filecoin";
    CoinType[CoinType["band"] = 494] = "band";
    CoinType[CoinType["theta"] = 500] = "theta";
    CoinType[CoinType["solana"] = 501] = "solana";
    CoinType[CoinType["elrond"] = 508] = "elrond";
    CoinType[CoinType["binance"] = 714] = "binance";
    CoinType[CoinType["vechain"] = 818] = "vechain";
    CoinType[CoinType["callisto"] = 820] = "callisto";
    CoinType[CoinType["neo"] = 888] = "neo";
    CoinType[CoinType["tomochain"] = 889] = "tomochain";
    CoinType[CoinType["thundertoken"] = 1001] = "thundertoken";
    CoinType[CoinType["harmony"] = 1023] = "harmony";
    CoinType[CoinType["oasis"] = 474] = "oasis";
    CoinType[CoinType["ontology"] = 1024] = "ontology";
    CoinType[CoinType["tezos"] = 1729] = "tezos";
    CoinType[CoinType["cardano"] = 1815] = "cardano";
    CoinType[CoinType["kin"] = 2017] = "kin";
    CoinType[CoinType["qtum"] = 2301] = "qtum";
    CoinType[CoinType["nebulas"] = 2718] = "nebulas";
    CoinType[CoinType["gochain"] = 6060] = "gochain";
    CoinType[CoinType["nuls"] = 8964] = "nuls";
    CoinType[CoinType["zelcash"] = 19167] = "zelcash";
    CoinType[CoinType["wanchain"] = 5718350] = "wanchain";
    CoinType[CoinType["waves"] = 5741564] = "waves";
    CoinType[CoinType["bsc"] = 10000714] = "bsc";
    CoinType[CoinType["smartchain"] = 20000714] = "smartchain";
    CoinType[CoinType["polygon"] = 966] = "polygon";
    CoinType[CoinType["thorchain"] = 931] = "thorchain";
...
(function (CoinType) {
    ...
    CoinType.symbol = symbol;
    function slip44(coin) {
        switch (coin) {
            case CoinType.bitcoin:
                return 0;
            case CoinType.litecoin:
