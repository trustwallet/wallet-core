...
describe('Wallet Core types tests', () => {
    ...
    it('test Ethereum encoding SigningInput', () => {
        ...
        expect(Buffer.from(encoded).toString('hex')).to.equal("0a01011201091a0504a817c800220252082a2a307833353335333533353335333533353335333533353335333533353335333533353335333533353335320c0a0a0a080de0b6b3a76400003a204646464646464646464646464646464646464646464646464646464646464646")
    })
