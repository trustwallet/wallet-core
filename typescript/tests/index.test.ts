...
describe('Wallet Core types tests', () => {
    ...
    it('test Ethereum encoding SigningInput', () => {
        const input = TW.Ethereum.Proto.SigningInput.create({
            ...
            maxInclusionFeePerGas: Buffer.from('00', 'hex'),
            maxFeePerGas: Buffer.from('00', 'hex'),
        ...
        expect(Buffer.from(encoded).toString('hex')).to.equal("0a01011201091a0504a817c800220252082a01003201003a2a307833353335333533353335333533353335333533353335333533353335333533353335333533353335422046464646464646464646464646464646464646464646464646464646464646464a0c0a0a0a080de0b6b3a7640000")
    })
