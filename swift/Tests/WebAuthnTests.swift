...
class WebAuthnTests: XCTestCase {
    ...
    func testGetRSValues() {
        ...
        let result = WebAuthn.getRSValues(signature: signature)!.data
    ...
    func testReconstructOriginalMessage() {
        ...
        let result = WebAuthn.reconstructOriginalMessage(authenticatorData: authenticatorData, clientDataJSON: clientDataJSON)!.data
