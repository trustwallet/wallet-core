...
class OntologyAddressTests: XCTestCase {
    ...
    func testIsValid() {
        XCTAssertFalse(AnyAddress.isValidString(string: "abc", coin: .ontology))
        XCTAssertFalse(AnyAddress.isValidString(string: "0x5aAeb6053F3E94C9b9A09f33669435E7Ef1BeAed", coin: .ontology))
        XCTAssertTrue(AnyAddress.isValidString(string: "ANDfjwrUroaVtvBguDtrWKRMyxFwvVwnZD", coin: .ontology))
    }
