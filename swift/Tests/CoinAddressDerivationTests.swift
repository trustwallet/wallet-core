        ...
        for _ in 0..<4 {
            for coin in CoinType.allCases {
                ...
                case .eos:
                    ...
                    assertCoinDerivation(coin, expectedResult, derivedAddress, address)
                case .ethereum, .smartChain, .polygon, .optimism, .arbitrum, .ecochain, .avalancheCChain:
                ...
                case .oasis:
                    ...
                    assertCoinDerivation(coin, expectedResult, derivedAddress, address)
                case .avalancheXChain:
                    let expectedResult = "X-avax1n7sz4f043sx76tydchphveqqn9ju9atp266f9s"
                    assertCoinDerivation(coin, expectedResult, derivedAddress, address)
                case .thorchain:
