    ...
    func testSign() {
        ...
        let input = IoTeXSigningInput.with {
            ...
            $0.transfer = IoTeXTransfer.with {
                $0.amount = "1"
                $0.recipient = AnyAddress(string: "io1e2nqsyt7fkpzs5x7zf2uk0jj72teu5n6aku3tr", coin: coin)!.description
            }
            $0.privateKey = privateKey.data
        }

        let output: IoTeXSigningOutput = AnySigner.sign(input: input, coin: coin)
