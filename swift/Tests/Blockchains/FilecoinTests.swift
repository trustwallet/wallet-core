...
class FilecoinTests: XCTestCase {
    ...
    func testCreateAddress() {
        let privateKey = PrivateKey(data: Data(hexString: "1d969865e189957b9824bd34f26d5cbf357fda1a6d844cbf0c9ab1ed93fa7dbe")!, curve: CoinType.filecoin.curve)!
    ...
    func testCreateDelegatedAddress() {
        let privateKey = PrivateKey(data: Data(hexString: "825d2bb32965764a98338139412c7591ed54c951dd65504cd8ddaeaa0fea7b2a")!, curve: CoinType.filecoin.curve)!
        let publicKey = privateKey.getPublicKeySecp256k1(compressed: false)
