...
class LitecoinTests: XCTestCase {
    func testAddress() {
        ...
        let legacyAddress = BitcoinAddress(publicKey: publicKey1, prefix: CoinTypeConfiguration.getP2PKHPrefix(type: CoinType.litecoin))!
    ...
    func testDeriveFromLtub() {
        ...
        XCTAssertEqual(BitcoinAddress(publicKey: xpubAddr2, prefix: CoinTypeConfiguration.getP2PKHPrefix(type: CoinType.litecoin))!.description, "LdJvSS8gcRSN1WbSEj6srV8dKzGcybHGKt")
        XCTAssertEqual(BitcoinAddress(publicKey: xpubAddr9, prefix: CoinTypeConfiguration.getP2PKHPrefix(type: CoinType.litecoin))!.description, "Laj4byUKgW3wuou4G3XCAPWqzVc3SdEpQk")
    }
