...
class LitecoinTests: XCTestCase {
    func testAddress() {
        ...
        let legacyAddress = BitcoinAddress(publicKey: publicKey1, prefix: CoinTypeConfiguration.getP2PKHPrefix(type: .litecoin))!
        ...
        let compatibleAddress = BitcoinAddress.compatibleAddress(publicKey: publicKey2, prefix: CoinTypeConfiguration.getP2SHPrefix(type: .litecoin))
    ...
    func testDeriveFromLtub() {
        ...
        XCTAssertEqual(BitcoinAddress(publicKey: xpubAddr2, prefix: CoinTypeConfiguration.getP2PKHPrefix(type: .litecoin))!.description, "LdJvSS8gcRSN1WbSEj6srV8dKzGcybHGKt")
        XCTAssertEqual(BitcoinAddress(publicKey: xpubAddr9, prefix: CoinTypeConfiguration.getP2PKHPrefix(type: .litecoin))!.description, "Laj4byUKgW3wuou4G3XCAPWqzVc3SdEpQk")
    }
    ...
    func testDeriveFromMtub() {
        ...
        XCTAssertEqual(BitcoinAddress.compatibleAddress(publicKey: ypubAddr3, prefix: CoinTypeConfiguration.getP2SHPrefix(type: .litecoin)).description, "MVr2vvjyaTzmfX3LFZcg5KZ7Cc36pgAWcy")
        XCTAssertEqual(BitcoinAddress.compatibleAddress(publicKey: ypubAddr10, prefix: CoinTypeConfiguration.getP2SHPrefix(type: .litecoin)).description, "MTgkF6T5h92QDmpFsBk4fJeYt3dx5ERQtD")
    }
