...
class CryptoorgTests: XCTestCase {
    ...
    func testAddress() {
        ...
        let addressFromString = AnyAddress(string: "cro1z53wwe7md6cewz9sqwqzn0aavpaun0gw39h3rd", coin: coin)!
    ...
    func testSign() {
        ...
        let fromAddress = AnyAddress(publicKey: publicKey, coin: coin)
