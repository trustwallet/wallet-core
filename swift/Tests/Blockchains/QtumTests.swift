...
class QtumTests: XCTestCase {
    func testAddress() {
        ...
        let legacyAddress = BitcoinAddress(publicKey: publicKey1, prefix: CoinTypeConfiguration.getP2PKHPrefix(type: CoinType.qtum))!
    ...
    func testDeriveFromXpub() {
        ...
        XCTAssertEqual(BitcoinAddress(publicKey: xpubAddr2, prefix: CoinTypeConfiguration.getP2PKHPrefix(type: CoinType.qtum))!.description, "QStYeAAfiYKxsABzY9yugHDpm5bsynYPqc")
        XCTAssertEqual(BitcoinAddress(publicKey: xpubAddr9, prefix: CoinTypeConfiguration.getP2PKHPrefix(type: CoinType.qtum))!.description, "QfbKFChfhx1s4VXS9BzaVJgyKw5a1hnFg4")
    }
