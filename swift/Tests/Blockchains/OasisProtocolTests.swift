...
class OasisProtocolTests: XCTestCase {

    func testAddress() {

        let key = PrivateKey(data: Data(hexString: "4f8b5676990b00e23d9904a92deb8d8f428ff289c8939926358f1d20537c21a0")!)!
        let pubkey = key.getPublicKeyEd25519()
        let address = AnyAddress(publicKey: pubkey, coin: .oasisProtocol)
        let addressFromString = AnyAddress(string: "oasis1qzawzy5kaa2xgphenf3r0f5enpr3mx5dps559yxm", coin: .oasisProtocol)!
    ...
    func testSign() {
        ...
        let input = OasisProtocolSigningInput.with {
            $0.privateKey = privateKey.data
            $0.transfer = OasisProtocolTransferMessage.with {
        ...
        let output: OasisProtocolSigningOutput = AnySigner.sign(input: input, coin: .oasisProtocol)
