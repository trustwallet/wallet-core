...
class GroestlcoinTransactionSignerTests: XCTestCase {
    ...
    func testSignP2WPKH() throws {
        ...
        XCTAssertEqual(output.error.code, TW_Common_Proto_SigningError.noError, "Error signing: \(output.error)")
        XCTAssertTrue(output.error.text.isEmpty, "Error signing: \(output.error)")
