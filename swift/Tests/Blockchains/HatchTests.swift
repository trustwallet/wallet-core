...
class HatchAddressTests: XCTestCase {
    ...
    func testExtendedKeys() {
        ...
        let xprv = wallet.getExtendedPrivateKey(purpose: .bip44, coin: .hatch, version: .xprv)
        let xpub = wallet.getExtendedPubKey(purpose: .bip44, coin: .hatch, version: .xpub)
