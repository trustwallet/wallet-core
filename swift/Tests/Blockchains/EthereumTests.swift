...
class EthereumTests: XCTestCase {
    ...
    func testERC4337DeploymentAddress() {
    ...
    func testERC4337NativeTransferAccountNotDeployed() throws {
        let input = EthereumSigningInput.with {
            $0.txMode = .userOp
            ...
            $0.userOperation = EthereumUserOperation.with {
                ...
                $0.sender = "0x5A87209b755781cF65fEeEdd3855ade0317f4a92"
                $0.initCode = Data(hexString: "00")!
        ...
        XCTAssertEqual(String(data: output.pre_hash, encoding: .utf8), "")
    ...
    func testERC4337NativeTransferAccountDeployed() throws {
        let input = EthereumSigningInput.with {
            $0.txMode = .userOp
            $0.chainID = Data(hexString: "05")!
            $0.nonce = Data(hexString: "01")!
    ...
    func testERC4337ERC20TransferAccountDeployed() throws {
        let input = EthereumSigningInput.with {
            $0.txMode = .userOp
            $0.chainID = Data(hexString: "05")!
    ...
    func testERC4337ERC20ApproveAccountDeployed() throws {
        let input = EthereumSigningInput.with {
            $0.txMode = .userOp
            $0.chainID = Data(hexString: "05")!
            $0.nonce = Data(hexString: "09")!
    ...
    func testERC4337ERC721TransferAccountDeployed() throws {
        let input = EthereumSigningInput.with {
            $0.txMode = .userOp
            $0.chainID = Data(hexString: "05")!
    ...
    func testERC4337ERC1155TransferAccountDeployed() throws {
        let input = EthereumSigningInput.with {
            $0.txMode = .userOp
            $0.chainID = Data(hexString: "05")!
            ...
            $0.userOperation = EthereumUserOperation.with {
                $0.entryPoint = "0x1306b01bC3e4AD202612D3843387e94737673F53"
                $0.sender = "0x76627b8D1E01fAF0C73B69625BC1fCb8FA19a2AD"
