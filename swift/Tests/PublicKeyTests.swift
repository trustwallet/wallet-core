...
class PublicKeyTests: XCTestCase {
    ...
    func testCompressed() {
        let privateKey = PrivateKey(data: Data(hexString: "afeefca74d9a325cf1d6b6911d61a65c32afa8e02bd5e78e2e4ac2910bab45f5")!, curve: .secp256k1)!
    ...
    func testVerify() {
        ...
        let privateKey1 = PrivateKey(data: Data(hexString: "afeefca74d9a325cf1d6b6911d61a65c32afa8e02bd5e78e2e4ac2910bab45f5")!, curve: .ed25519)!
        let sig1 = privateKey1.sign(digest: message)!
        let result1 = privateKey1.getPublicKeyEd25519()
                            .verify(signature: sig1, message: message)

        let privateKey2 = PrivateKey(data: Data(hexString: "afeefca74d9a325cf1d6b6911d61a65c32afa8e02bd5e78e2e4ac2910bab45f5")!, curve: .ed25519Blake2bNano)!
        let sig2 = privateKey2.sign(digest: message)!
        let result2 = privateKey2.getPublicKeyEd25519Blake2b()
            .verify(signature: sig2, message: message)

        let privateKey3 = PrivateKey(data: Data(hexString: "afeefca74d9a325cf1d6b6911d61a65c32afa8e02bd5e78e2e4ac2910bab45f5")!, curve: .secp256k1)!
        let sig3 = privateKey3.sign(digest: message)!
        let result3 = privateKey3.getPublicKeySecp256k1(compressed: true)
