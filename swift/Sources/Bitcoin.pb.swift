...
extension TW_Bitcoin_Proto_SigningOutput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    5: .standard(proto: "transaction_hash"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _transactionHash: String = String()
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 5: try decoder.decodeSingularStringField(value: &_storage._transactionHash)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._transactionHash.isEmpty {
        try visitor.visitSingularStringField(value: _storage._transactionHash, fieldNumber: 5)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
